...
//应用编码
export const APPCODE = '81H11017';

//单据类型
export const BILL_TYPE_CODE = 'XSZN';
 ...
 */
export const LIST = {
        page_title: '81H11017-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11017_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveguideHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteguideHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardguideHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageguideHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkguideHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitguideHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitguideHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_guide',           //表头主键字段名
        body_id: 'pk_xsznd',           //表体主键字段名
