...
//应用编码
export const APPCODE = '81H10555';

//单据类型
export const BILL_TYPE_CODE = 'RWFP';
 ...
 */
export const LIST = {
        page_title: '81H10555-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10555_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savetaskallocationHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletetaskallocationHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardtaskallocationHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagetaskallocationHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypktaskallocationHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/committaskallocationHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommittaskallocationHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_taskallocation',           //表头主键字段名
        body_id: 'pk_task_detail',           //表体主键字段名
