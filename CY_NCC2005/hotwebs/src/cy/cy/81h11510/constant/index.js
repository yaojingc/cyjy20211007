...
//应用编码
export const APPCODE = '81H11510';

//单据类型
export const BILL_TYPE_CODE = 'SKLS';
 ...
 */
export const LIST = {
        page_title: '81H11510-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11510_LIST',                     //页面编码
...
export const REQUEST_URL = {
        setBillCode:`/nccloud/cy/cy/setDesHVO.do`,                 //单据号赋值
        save: `/nccloud/cy/cy/savebankcollflowHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletebankcollflowHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardbankcollflowHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagebankcollflowHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkbankcollflowHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitbankcollflowHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitbankcollflowHVO.do`,               //收回
        invoice: `/nccloud/cy/cy/invoicebankcollflowHVO.do`,               //已开票按钮
