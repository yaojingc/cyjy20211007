...
//应用编码
export const APPCODE = '81H10120';

//单据类型
export const BILL_TYPE_CODE = 'XZBJ';
 ...
 */
export const LIST = {
        page_title: '81H10120-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10120_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveclassxzHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteclassxzHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardclassxzHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageclassxzHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkclassxzHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitclassxzHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitclassxzHVO.do`,               //收回
