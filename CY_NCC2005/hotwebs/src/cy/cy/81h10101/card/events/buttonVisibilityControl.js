...
export function buttonVisibilityControl(props) {
    ...
    */
    ...
    CARD_BUTTON.addRow, CARD_BUTTON.deleteRow, CARD_BUTTON.copyRows,CARD_BUTTON.addRowLink, CARD_BUTTON.deleteRowLink,
    CARD_BUTTON.addRowClass, CARD_BUTTON.deleteRowClass,CARD_BUTTON.addRowTop, CARD_BUTTON.deleteRowTop,CARD_BUTTON.addRowBusin, CARD_BUTTON.deleteRowBusin];
