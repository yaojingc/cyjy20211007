...
class Card extends Component {
        ...
        componentWillMount() {
                ...
                window.onbeforeunload = () => {
                        ...
                        if (status == STATUS.edit) {
                                return this.state.json['81H10101-000007'];/* 国际化处理： 当前单据未保存，您确认离开此页面？*/
                        }
                };
        }
        ...
        getTableHeadLink = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_link,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
        ...
        getTableHeadClass = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_class,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
        ...
        getTableHeadTop = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_top,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
        ...
        getTableHeadBusin = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_busin,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
                        ...
                        <div className="nc-bill-card">
                                ...
                                <div className="nc-bill-bottom-area">
                                        <div className="nc-bill-table-area">
                                                ...
                                                {createCardTable(CARD.table_code_link, {
                                                        tableHead: this.getTableHeadLink.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                                ...
                                                {createCardTable(CARD.table_code_class, {
                                                        tableHead: this.getTableHeadClass.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                                ...
                                                {createCardTable(CARD.table_code_top, {
                                                        tableHead: this.getTableHeadTop.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                                ...
                                                {createCardTable(CARD.table_code_busin, {
                                                        tableHead: this.getTableHeadBusin.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['81H10101-000018']} /* 国际化处理： 指派*/
