...
import { pageInfoClick, handleDoubleClick, listCommit, allotSchool } from './events/listOperator';
import SchoolAllotModal from './schoolAllotModal';
...
class List extends Component {
        ...
        onClickModal = (checkedRows) => {
                this.modalDemoRefer.open(checkedRows)
        }
        ...
        render() {
                ...
                return (
                        <div className="nc-bill-list">
                                ...
                                {
                                        /** allotDataManager={(indexProps, data) => {
                                               allotSchool(indexProps, data)
                                       }} */
                                }

                                {<SchoolAllotModal onRef={(ref) => { this.modalDemoRefer = ref }} />}
