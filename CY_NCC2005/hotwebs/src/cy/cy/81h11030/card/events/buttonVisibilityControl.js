...
export function buttonVisibilityControl(props) {
    ...
    */
    ...
    CARD_BUTTON.addRow, CARD_BUTTON.deleteRow, CARD_BUTTON.copyRows, CARD_BUTTON.CreatCs,
    ...
    if (!isBrowse) { //编辑态
        ...
        if (!id) {//点击新增然后点击取消后
            ...
            let commonBtn = [CARD_BUTTON.CreatCs, CARD_BUTTON.disapp2, CARD_BUTTON.create, CARD_BUTTON.copy, CARD_BUTTON.attachment, ...unionBtn, CARD_BUTTON.print, CARD_BUTTON.output, CARD_BUTTON.refresh, CARD_BUTTON.fold, CARD_BUTTON.unfold];
            switch (billStatus) {
                case STATUS.NOSTATE:
