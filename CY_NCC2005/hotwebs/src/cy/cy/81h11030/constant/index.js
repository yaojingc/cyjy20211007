...
//应用编码
export const APPCODE = '81H11030';

//单据类型
export const BILL_TYPE_CODE = 'KBDY';
 ...
 */
export const LIST = {
        page_title: '81H11030-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11030_LIST',                     //页面编码
...
export const REQUEST_URL = {
        clasituation:`/nccloud/cy/cy/clasituation.do`,                       //生成学生上课情况
        save: `/nccloud/cy/cy/saveclsscheduleHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteclsscheduleHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardclsscheduleHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageclsscheduleHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkclsscheduleHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitclsscheduleHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitclsscheduleHVO.do`,               //收回

        importExcelKB: `/nccloud/cy/cy/importkb.do`,                       // 课表导入
...
export const PRIMARY_KEY = {
        head_id: 'pk_clsschedule',           //表头主键字段名
        body_id: 'pk_stumark',           //表体主键字段名
