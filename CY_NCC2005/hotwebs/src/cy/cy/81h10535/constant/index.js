...
//应用编码
export const APPCODE = '81H10535';

//单据类型
export const BILL_TYPE_CODE = 'JDSQ';
 ...
 */
export const LIST = {
        page_title: '81H10535-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10535_LIST',                     //页面编码
...
export const CARD = {
        ...
        page_code: '81H10535_CARD',                      //页面编码

        form_id: 'card_head',                            //表头表单区
        table_code: 'card_body',                         //表体表格区（到访人员信息）
        table_code_sch: 'card_body_sch',                     //表体表格区（行程安排维护）
        table_code_kc: 'card_body_kc',                      //表体表格区（考察效果维护）
        ...
        shoulder_btn_code_sch: 'tabs_head_sch',              //表体肩部按钮区
        shoulder_btn_code_kc: 'tabs_head_kc',               //表体肩部按钮区
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savejiedaiapplyHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletejiedaiapplyHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardjiedaiapplyHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagejiedaiapplyHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkjiedaiapplyHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitjiedaiapplyHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitjiedaiapplyHVO.do`,               //收回
...
export const CARD_BUTTON = {
        ...
        addRow: 'addRow',
        deleteRow: 'deleteRow',
        addRowSch: 'addRowSch',//行程安排维护
        deleteRowSch: 'deleteRowSch',
        addRowKc: 'addRowKc',//考察效果维护
        deleteRowKc: 'deleteRowKc',
...
export const PRIMARY_KEY = {
        head_id: 'pk_jiedaiapply',           //表头主键字段名
        body_id: 'pk_kceffect',           //表体主键字段名
