...
class Card extends Component {
        ...
        componentWillMount() {
                ...
                window.onbeforeunload = () => {
                        ...
                        if (status == STATUS.edit) {
                                return this.state.json['81H10535-000007'];/* 国际化处理： 当前单据未保存，您确认离开此页面？*/
                        }
                };
        }
        ...
        getTableHeadSch = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_sch,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
        ...
        getTableHeadKc = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_kc,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
                ...
                return (
                        <div className="nc-bill-card">
                                ...
                                <div className="nc-bill-bottom-area">
                                        <div className="nc-bill-table-area">
                                                {createCardTable(CARD.table_code, {
                                                 ...
                                                 {createCardTable(CARD.table_code_sch, {
                                                        tableHead: this.getTableHeadSch.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                                 ...
                                                 {createCardTable(CARD.table_code_kc, {                                  tableHead: this.getTableHeadKc.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['81H10535-000018']} /* 国际化处理： 指派*/
