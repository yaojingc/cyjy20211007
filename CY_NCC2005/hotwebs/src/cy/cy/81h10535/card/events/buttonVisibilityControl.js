...
export function buttonVisibilityControl(props) {
    ...
    */
    ...
    CARD_BUTTON.addRow, CARD_BUTTON.deleteRow, CARD_BUTTON.copyRows,CARD_BUTTON.addRowKc,CARD_BUTTON.addRowSch,CARD_BUTTON.deleteRowKc,
    CARD_BUTTON.insertRow, CARD_BUTTON.delRow, CARD_BUTTON.copyRow, CARD_BUTTON.pasteHere, CARD_BUTTON.expand,CARD_BUTTON.deleteRowSch];
    //联查按钮
