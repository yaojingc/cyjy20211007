...
//应用编码
export const APPCODE = '81H10545';

//单据类型
export const BILL_TYPE_CODE = 'YJSQ';
 ...
 */
export const LIST = {
        page_title: '81H10545-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10545_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveyejiapplyHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteyejiapplyHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardyejiapplyHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageyejiapplyHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkyejiapplyHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commityejiapplyHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommityejiapplyHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_yejiapply',           //表头主键字段名
        body_id: 'pk_yejichild',           //表体主键字段名
