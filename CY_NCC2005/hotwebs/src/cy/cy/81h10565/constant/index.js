...
//应用编码
export const APPCODE = '81H10565';

//单据类型
export const BILL_TYPE_CODE = 'XCAP';
 ...
 */
export const LIST = {
        page_title: '81H10565-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10565_LIST',                     //页面编码
...
export const CARD = {
        ...
        page_code: '81H10565_CARD',                      //页面编码

        form_id: 'card_head',                            //表头表单区
        table_code: 'card_body',                         //表体表格区
        table_code_b: 'card_body_b',                 //表体表格区（行程安排维护）
        ...
        head_btn_code: 'cardhead',                      //表头按钮区
        shoulder_btn_code: 'tabs_head',                  //表体肩部按钮区
        shoulder_btn_code_b: 'tabs_head_b',          //表体肩部按钮区
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveplantravelHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteplantravelHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardplantravelHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageplantravelHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkplantravelHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitplantravelHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitplantravelHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_plantravel',           //表头主键字段名
        body_id: 'pk_scheduling',           //表体主键字段名
