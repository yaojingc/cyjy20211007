        ...
        componentWillMount() {
                ...
                window.onbeforeunload = () => {
                        ...
                        if (status == STATUS.edit) {
                                return this.state.json['81H10565-000007'];/* 国际化处理： 当前单据未保存，您确认离开此页面？*/
                        }
                };
        }
                        ...
                        <div className="nc-bill-card">
                                ...
                                <div className="nc-bill-bottom-area">
                                        <div className="nc-bill-table-area">
                                                {createCardTable(CARD.table_code, {
                                                ...
                                                })}{createCardTable(CARD.table_code_b, {
                                                        tableHead: this.getTableHeadB.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                                        ...
                                                        onAfterEvent: afterTableEvent,
                                                        modelSave: buttonClick.bind(this, { ...this.props, json: this.state.json }, CARD_BUTTON.save, undefined, true),
                                                })}{createCardTable(CARD.table_code_kc, {                                  
                                                        tableHead: this.getTableHeadKc.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['81H10565-000018']} /* 国际化处理： 指派*/
