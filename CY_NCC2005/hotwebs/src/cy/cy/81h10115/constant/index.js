...
//应用编码
export const APPCODE = '81H10115';

//单据类型
export const BILL_TYPE_CODE = 'CYBJ';
 ...
 */
export const LIST = {
        page_title: '81H10115-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10115_LIST',                     //页面编码
...
export const REQUEST_URL = {
        setBillCode:`/nccloud/cy/cy/setBillCodeHVO.do`,                 //单据号赋值

        save: `/nccloud/cy/cy/saveclasscyHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteclasscyHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardclasscyHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageclasscyHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkclasscyHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitclasscyHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitclasscyHVO.do`,               //收回
