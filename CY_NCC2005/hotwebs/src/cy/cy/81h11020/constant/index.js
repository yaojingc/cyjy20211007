...
//应用编码
export const APPCODE = '81H11020';

//单据类型
export const BILL_TYPE_CODE = 'SJDA';
 ...
 */
export const LIST = {
        page_title: '81H11020-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11020_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savetestpaperfileHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletetestpaperfileHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardtestpaperfileHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagetestpaperfileHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypktestpaperfileHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/committestpaperfileHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommittestpaperfileHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_testpaperfile',           //表头主键字段名
        body_id: 'pk_testd',           //表体主键字段名
