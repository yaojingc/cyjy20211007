...
//应用编码
export const APPCODE = '81H10549';

//单据类型
export const BILL_TYPE_CODE = 'BFJH';
 ...
 */
export const LIST = {
        page_title: '81H10549-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10549_LIST',                     //页面编码
