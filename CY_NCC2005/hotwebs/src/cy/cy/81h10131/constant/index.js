...
//应用编码
export const APPCODE = '81H10131';

//单据类型
export const BILL_TYPE_CODE = 'XXZZ';
 ...
 */
export const LIST = {
        page_title: '81H10131-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10131_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savemsgstationHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletemsgstationHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardmsgstationHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagemsgstationHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkmsgstationHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitmsgstationHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitmsgstationHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_msgstation',           //表头主键字段名
        body_id: 'pk_msgchild',           //表体主键字段名
