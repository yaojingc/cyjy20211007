...
//应用编码
export const APPCODE = '81H11001';

//单据类型
export const BILL_TYPE_CODE = 'KFTD';
 ...
 */
export const LIST = {
        page_title: '81H11001-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11001_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savecallcenterHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletecallcenterHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardcallcenterHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagecallcenterHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkcallcenterHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitcallcenterHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitcallcenterHVO.do`,               //收回
