...
//应用编码
export const APPCODE = '81H10540';

//单据类型
export const BILL_TYPE_CODE = 'XFJM';
 ...
 */
export const LIST = {
        page_title: '81H10540-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10540_LIST',                     //页面编码
...
export const REQUEST_URL = {
        setBillCode:`/nccloud/cy/cy/SetAddressActionHVO.do`, 
        save: `/nccloud/cy/cy/savexuefeijmHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletexuefeijmHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardxuefeijmHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagexuefeijmHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkxuefeijmHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitxuefeijmHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitxuefeijmHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_xfapply',           //表头主键字段名
        body_id: 'pk_xfd',           //表体主键字段名
