...
//应用编码
export const APPCODE = '81H10501';

//单据类型
export const BILL_TYPE_CODE = 'XXSQ';
 ...
 */
export const LIST = {
        page_title: '81H10501-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10501_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveschoolformHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteschoolformHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardschoolformHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageschoolformHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkschoolformHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitschoolformHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitschoolformHVO.do`,               //收回
