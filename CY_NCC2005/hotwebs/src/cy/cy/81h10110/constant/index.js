...
//应用编码
export const APPCODE = '81H10110';

//单据类型
export const BILL_TYPE_CODE = 'LSDA';
 ...
 */
export const LIST = {
        page_title: '81H10110-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10110_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveteacherfileHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteteacherfileHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardteacherfileHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageteacherfileHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkteacherfileHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/committeacherfileHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitteacherfileHVO.do`,               //收回
