...
//应用编码
export const APPCODE = '81H11025';

//单据类型
export const BILL_TYPE_CODE = 'XSCJ';
 ...
 */
export const LIST = {
        page_title: '81H11025-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11025_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savestumarkdataHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletestumarkdataHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardstumarkdataHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagestumarkdataHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkstumarkdataHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitstumarkdataHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitstumarkdataHVO.do`,               //收回
        queryStuOfClasscy:`/nccloud/cy/cy/queryStuOfClasscy.do`,     // 选中班级后查询班级下的所有学生数据赋值表体
...
export const PRIMARY_KEY = {
        head_id: 'pk_stumark',           //表头主键字段名
        body_id: 'pk_stumarkd',           //表体主键字段名
