...
//应用编码
export const APPCODE = '81H10125';

//单据类型
export const BILL_TYPE_CODE = 'YWDA';
 ...
 */
export const LIST = {
        page_title: '81H10125-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10125_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savesalesmanfileHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletesalesmanfileHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardsalesmanfileHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagesalesmanfileHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypksalesmanfileHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitsalesmanfileHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitsalesmanfileHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_salesman',           //表头主键字段名
        body_id: 'pk_sign',           //表体主键字段名
