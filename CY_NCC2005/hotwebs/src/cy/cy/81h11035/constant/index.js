...
//应用编码
export const APPCODE = '81H11035';

//单据类型
export const BILL_TYPE_CODE = 'SKQK';
 ...
 */
export const LIST = {
        page_title: '81H11035-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11035_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveclassituationHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteclassituationHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardclassituationHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageclassituationHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkclassituationHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitclassituationHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitclassituationHVO.do`,               //收回
