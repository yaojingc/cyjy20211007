    ...
    switch (id) {
        ...
        case CARD_BUTTON.delete:
            promptBox({
                ...
                title: this.state.json['81H10510-000000'],/* 国际化处理： 删除*/
                content: this.state.json['81H10510-000001'],/* 国际化处理： 确定删除吗？*/
                beSureBtnClick: () => {
        ...
        case CARD_BUTTON.cancel:
            promptBox({
                color: STATUS.warning,
                title: this.state.json['81H10510-000002'],/* 国际化处理： 取消*/
                content: this.state.json['81H10510-000003'],/* 国际化处理： 是否确认要取消?*/
                beSureBtnClick: () => {
