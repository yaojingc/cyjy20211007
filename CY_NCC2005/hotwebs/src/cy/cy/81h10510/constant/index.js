...
//应用编码
export const APPCODE = '81H10510';

//单据类型
export const BILL_TYPE_CODE = 'GZRB';
 ...
 */
export const LIST = {
        page_title: '81H10510-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10510_LIST',                     //页面编码
...
export const REQUEST_URL = {
   setBillCode:`/nccloud/cy/cy/setBillCode1HVO.do`, 
        save: `/nccloud/cy/cy/savedailyHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletedailyHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycarddailyHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagedailyHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkdailyHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitdailyHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitdailyHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_daily',           //表头主键字段名
        body_id: 'pk_dailyd',           //表体主键字段名
