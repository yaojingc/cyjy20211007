...
//应用编码
export const APPCODE = '81H11505';

//单据类型
export const BILL_TYPE_CODE = 'SKHT';
 ...
 */
export const LIST = {
        page_title: '81H11505-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11505_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savecreditcontractHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletecreditcontractHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardcreditcontractHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagecreditcontractHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkcreditcontractHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitcreditcontractHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitcreditcontractHVO.do`,               //收回
...
//学费减免禁用按钮
export const CARD_ADD_DISABLED_BUTTON_XFJM = [CARD_BUTTON.addRow];
