...
//应用编码
export const APPCODE = '81H10505';

//单据类型
export const BILL_TYPE_CODE = 'LSSQ-Cxx-002'//'LSSQ';
 ...
 */
export const LIST = {
        page_title: '81H10505-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10505_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/saveteacherformHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deleteteacherformHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardteacherformHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypageteacherformHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkteacherformHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/committeacherformHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitteacherformHVO.do`,               //收回
        teacherAssign: `/nccloud/cy/cy/teacherAssign.do`,                   //老师讲师分配
        cancelTeacherAssign: `/nccloud/cy/cy/cancelTeacherAssign.do`,  // 取消分配
        toCard: '/card',
        toList: '/list'
};
...
export const LIST_BUTTON = {
        ...
        cancelTeacherAssign:'CancelTeacherAssign',
        commit: 'CommitBtn',
...
export const PRIMARY_KEY = {
        head_id: 'pk_teacherform',           //表头主键字段名
        body_id: 'pk_detail',           //表体主键字段名
