...
import { pageInfoClick, handleDoubleClick, listCommit, teacherAssign } from './events/listOperator';
...
class List extends Component {
        ...
        onClickModal = (props,checkedRows) => {
                console.log("props--onClickModal--",props);
                this.modalDemoRefer.open(props,checkedRows)
        };
        ...
        render() {
                ...
                return (
                        <div className="nc-bill-list">
                                ...
                                {<TeacherAssignModal teacherAssignManager={(indexProps,data) => {
                                        teacherAssign(indexProps, data)
                                }}
                                        onRef={(ref) => { this.modalDemoRefer = ref }} />
                                }
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['81H10505-000018']} /* 国际化处理： 指派*/
