...
class Card extends Component {
        ...
        componentWillMount() {
                ...
                window.onbeforeunload = () => {
                        ...
                        if (status == STATUS.edit) {
                                return this.state.json['81H10105-000007'];/* 国际化处理： 当前单据未保存，您确认离开此页面？*/
                        }
                };
        }
        ...
        getTableHeadChange = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_change,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
        ...
        getTableHeadParent = () => (
                <div className="shoulder-definition-area">
                        <div className="definition-icons">
                                {this.props.button.createButtonApp({
                                        area: CARD.shoulder_btn_code_parent,
                                        onButtonClick: bodyButtonClick.bind(this),
                                        popContainer: document.querySelector('.header-button-area')
                                })}
                        </div>
        ...
        render() {
                let { form, cardPagination, BillHeadInfo, cardTable ,modal} = this.props;
                        ...
                        <div className="nc-bill-card">
                                ...
                                <div className="nc-bill-bottom-area">
                                        <div className="nc-bill-table-area">
                                                ...
                                                {createCardTable(CARD.table_code_change, {//（学生变动）
                                                        tableHead: this.getTableHeadChange.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                                ...
                                                {createCardTable(CARD.table_code_parent, {//（学生家长）
                                                        tableHead: this.getTableHeadParent.bind(this),
                                                        showCheck: true,
                                                        showIndex: true,
                                                        onSelected: bodySelectedEvent,
                                                        onSelectedAll: bodySelectedAllEvent,
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['81H10105-000018']} /* 国际化处理： 指派*/
