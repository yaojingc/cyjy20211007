...
export function buttonVisibilityControl(props) {
    ...
    */
    ...
    CARD_BUTTON.addRowChange, CARD_BUTTON.deleteRowChange, CARD_BUTTON.addRowParent, CARD_BUTTON.deleteRowParent];
    ...
    if (!isBrowse) { //编辑态
        ...
        if (!id) {//点击新增然后点击取消后
            ...
            let commonBtn = [CARD_BUTTON.stuSave, CARD_BUTTON.addRowStu, CARD_BUTTON.deleteRowStu, CARD_BUTTON.stuUpdate, CARD_BUTTON.beginSave, CARD_BUTTON.create, CARD_BUTTON.copy, CARD_BUTTON.attachment, ...unionBtn, CARD_BUTTON.print, CARD_BUTTON.output, CARD_BUTTON.refresh, CARD_BUTTON.fold, CARD_BUTTON.unfold];
            switch (billStatus) {
                case STATUS.NOSTATE:
