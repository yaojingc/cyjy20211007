...
//应用编码
export const APPCODE = '81H11515';

//单据类型
export const BILL_TYPE_CODE = 'TFSQ';
 ...
 */
export const LIST = {
        page_title: '81H11515-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H11515_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savereturncostHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletereturncostHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardreturncostHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagereturncostHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypkreturncostHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/commitreturncostHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommitreturncostHVO.do`,               //收回
...
export const CARD_BUTTON = {
        setReturnMoneyBtn: 'SetReturnMoneyBtn',//add by csh
        save: 'SaveBtn',
        saveAdd: 'SaveAddBtn',
