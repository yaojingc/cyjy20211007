...
import SetReturnMoneyModal from './events/setReturnMoneyModal';//add by csh
...
class Card extends Component {
        ...
        componentWillMount() {
                ...
                window.onbeforeunload = () => {
                        ...
                        if (status == STATUS.edit) {
                                return this.state.json['81H11515-000007'];/* 国际化处理： 当前单据未保存，您确认离开此页面？*/
                        }
                };
        }
        ...
        //点击设置退款金额 add by csh
        onClickModal = (returnMoneyData) => {
                this.modalDemoRefer.open(returnMoneyData)
        }

        //设置退款金额成功后更新该字段 add by csh
        updateSetMoney(money){
                this.props.form.setFormItemsValue('card_head',{'retuencost':{value:money,display:money}});
        }
        ...
        render() {
                ...
                return (
                        <div className="nc-bill-card">
                                ...
                                {/* 设置退款金额界面 add by csh */}
                                {<SetReturnMoneyModal onRef={(ref) => { this.modalDemoRefer = ref }} updateMoney={money=>this.updateSetMoney(money)} />}
                                ...
                                {this.state.compositeDisplay && (
                                        <ApprovalTrans
                                                title={this.state.json['81H11515-000018']} /* 国际化处理： 指派*/
