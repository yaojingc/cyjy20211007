...
//应用编码
export const APPCODE = '81H10560';

//单据类型
export const BILL_TYPE_CODE = 'RWFK';
 ...
 */
export const LIST = {
        page_title: '81H10560-000011',                  //页面标题 /* 国际化处理： 投融资费用*/

        page_code: '81H10560_LIST',                     //页面编码
...
export const REQUEST_URL = {
        save: `/nccloud/cy/cy/savetaskfeedbackHVO.do`,                       //保存
        delete: `/nccloud/cy/cy/deletetaskfeedbackHVO.do`,                        //删除
        queryCard: `/nccloud/cy/cy/querycardtaskfeedbackHVO.do`,                      //卡片查询
        queryList: `/nccloud/cy/cy/querypagetaskfeedbackHVO.do`,              //列表查询
        queryListByPks: `/nccloud/cy/cy/querypagebypktaskfeedbackHVO.do`,     //列表分页查询
        commit: `/nccloud/cy/cy/committaskfeedbackHVO.do`,                   //提交
        unCommit: `/nccloud/cy/cy/uncommittaskfeedbackHVO.do`,               //收回
...
export const PRIMARY_KEY = {
        head_id: 'pk_taskfeedback',           //表头主键字段名
