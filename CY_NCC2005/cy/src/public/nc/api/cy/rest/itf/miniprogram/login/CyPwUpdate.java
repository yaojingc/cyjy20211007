 ...
 * @author yao
 */
public class CyPwUpdate extends MiniProgramServlet implements IHttpServletAdaptor  {
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			loginVO = CyCommonUtils.getInstance(IStudenthvoMaintain.class).miniPwUpdate(loginVO);
