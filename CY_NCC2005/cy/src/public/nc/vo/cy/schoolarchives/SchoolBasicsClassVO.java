...
public class SchoolBasicsClassVO extends SuperVO {

	/**
	 * ����������
	 */
	public java.lang.String pk_class;
	/**
	 * �к�
	 */
	 ...
	 * ����
	 */
	public java.lang.Integer psnnum;
	/**
	 * �Ƿ񿪰�
	 */
	public UFBoolean whetherclas;
	/**
	 * δ����˵��
	 */
	...
	/**
	 * ���� pk_class��Getter����.������������������ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_class() {
		return this.pk_class;
	}

	/**
	 * ����pk_class��Setter����.������������������ ��������:2021-7-21
	 * 
	 * @param newPk_class java.lang.String
	 */
	public void setPk_class(java.lang.String pk_class) {
	...
	/**
	 * ���� psnnum��Getter����.������������ ��������:2021-7-21
	 * 
	 * @return java.lang.Integer
	 */
	public java.lang.Integer getPsnnum() {
		return this.psnnum;
	}

	/**
	 * ����psnnum��Setter����.������������ ��������:2021-7-21
	 * 
	 * @param newPsnnum java.lang.Integer
	 */
	public void setPsnnum(java.lang.Integer psnnum) {
		this.psnnum = psnnum;
	}

	/**
	 * ���� whetherclas��Getter����.���������Ƿ񿪰� ��������:2021-7-21
	 * 
	 * @return nc.vo.pub.lang.UFUFBoolean
	 */
	public UFBoolean getWhetherclas() {
		return this.whetherclas;
	}

	/**
	 * ����whetherclas��Setter����.���������Ƿ񿪰� ��������:2021-7-21
	 * 
	 * @param newWhetherclas nc.vo.pub.lang.UFUFBoolean
	 */
	public void setWhetherclas(UFBoolean whetherclas) {
		this.whetherclas = whetherclas;
	}

	/**
	 * ���� cause��Getter����.��������δ����˵�� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.schoolBasicsClassVO");
	}
}
