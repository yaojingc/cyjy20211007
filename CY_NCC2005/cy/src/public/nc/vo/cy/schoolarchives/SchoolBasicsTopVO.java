...
public class SchoolBasicsTopVO extends SuperVO {
	
/**
*ѧУά������
*/
public java.lang.String pk_top;
/**
*�к�
*/
...
*�ݷö���
*/
public java.lang.String visitobj;
/**
*���������
*/
public java.lang.String solveproblem;
/**
*�ݷ�Ѳ�����
*/
public java.lang.String visitpatrol;
/**
*�ȶ�����
*/
public java.lang.Integer stablelevel;
/**
*�Ƿ�����
*/
public UFBoolean redornot;
/**
*�꼶�����ֲ�
*/
public java.lang.String gradepsnnum;
/**
*�Ƿ��뾺����������
*/
public UFBoolean isexistside;
/**
*��������˵��
*/
...
*/
public java.lang.String getPk_top() {
return this.pk_top;
} 
...
* ����pk_top��Setter����.��������ѧУά������
* ��������:2021-7-21
* @param newPk_top java.lang.String
*/
public void setPk_top ( java.lang.String pk_top) {
this.pk_top=pk_top;
} 
...
* @return java.lang.String
*/
public java.lang.String getVisitobj() {
...
* ����visitobj��Setter����.���������ݷö���
* ��������:2021-7-21
* @param newVisitobj java.lang.String
*/
public void setVisitobj ( java.lang.String visitobj) {
...
* @return java.lang.String
*/
public java.lang.String getSolveproblem() {
...
* ����solveproblem��Setter����.�����������������
* ��������:2021-7-21
* @param newSolveproblem java.lang.String
*/
public void setSolveproblem ( java.lang.String solveproblem) {
this.solveproblem=solveproblem;
} 
 
/**
* ���� visitpatrol��Getter����.���������ݷ�Ѳ�����
*  ��������:2021-7-21
* @return java.lang.String
*/
public java.lang.String getVisitpatrol() {
return this.visitpatrol;
} 

/**
* ����visitpatrol��Setter����.���������ݷ�Ѳ�����
* ��������:2021-7-21
* @param newVisitpatrol java.lang.String
*/
public void setVisitpatrol ( java.lang.String visitpatrol) {
this.visitpatrol=visitpatrol;
} 
 
/**
* ���� stablelevel��Getter����.���������ȶ�����
*  ��������:2021-7-21
* @return nc.vo.cy.cyenum.StablelevelEnum
*/
public java.lang.Integer getStablelevel() {
return this.stablelevel;
} 

/**
* ����stablelevel��Setter����.���������ȶ�����
* ��������:2021-7-21
* @param newStablelevel nc.vo.cy.cyenum.StablelevelEnum
*/
public void setStablelevel ( java.lang.Integer stablelevel) {
...
* ����redornot��Setter����.���������Ƿ�����
* ��������:2021-7-21
* @param newRedornot nc.vo.pub.lang.UFUFBoolean
*/
public void setRedornot ( UFBoolean redornot) {
this.redornot=redornot;
} 
 
/**
* ���� gradepsnnum��Getter����.���������꼶�����ֲ�
*  ��������:2021-7-21
* @return java.lang.String
*/
public java.lang.String getGradepsnnum() {
return this.gradepsnnum;
} 

/**
* ����gradepsnnum��Setter����.���������꼶�����ֲ�
* ��������:2021-7-21
* @param newGradepsnnum java.lang.String
*/
public void setGradepsnnum ( java.lang.String gradepsnnum) {
this.gradepsnnum=gradepsnnum;
} 
 
/**
* ���� isexistside��Getter����.���������Ƿ��뾺����������
*  ��������:2021-7-21
* @return nc.vo.pub.lang.UFUFBoolean
*/
public UFBoolean getIsexistside() {
return this.isexistside;
} 

/**
* ����isexistside��Setter����.���������Ƿ��뾺����������
* ��������:2021-7-21
* @param newIsexistside nc.vo.pub.lang.UFUFBoolean
*/
public void setIsexistside ( UFBoolean isexistside) {
...
*/
public UFDateTime getVisitdate() {
...
* ����visitdate��Setter����.���������ݷ�����
* ��������:2021-7-21
* @param newVisitdate nc.vo.pub.lang.UFDateTime
*/
public void setVisitdate ( UFDateTime visitdate) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.schoolBasicsTopVO");
    }
   }
