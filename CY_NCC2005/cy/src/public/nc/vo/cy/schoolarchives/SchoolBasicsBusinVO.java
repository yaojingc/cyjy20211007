...
public class SchoolBasicsBusinVO extends SuperVO {

	/**
	 * ѧУҵ������
	 */
	public java.lang.String pk_busin;
	/**
	 * �к�
	 */
	...
	/**
	 * ���� pk_busin��Getter����.��������ѧУҵ������ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_busin() {
		return this.pk_busin;
	}

	/**
	 * ����pk_busin��Setter����.��������ѧУҵ������ ��������:2021-7-21
	 * 
	 * @param newPk_busin java.lang.String
	 */
	public void setPk_busin(java.lang.String pk_busin) {
		this.pk_busin = pk_busin;
	}
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.schoolBasicsBusinVO");
	}
}
