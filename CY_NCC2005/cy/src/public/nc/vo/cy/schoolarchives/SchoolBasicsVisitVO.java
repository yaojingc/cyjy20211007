...
public class SchoolBasicsVisitVO extends SuperVO {

	/**
	 * �ݷü�¼����
	 */
	public java.lang.String pk_visit;
	/**
	 * �к�
	 */
	 ...
	 * ѧУ���񼶱�
	 */
	public java.lang.Integer busilevel;
	/**
	 * ����˾�������
	 */
	public UFBoolean develsituation;
	/**
	 * ���꼶����
	 */
	 ...
	 * ���������������
	 */
	public java.lang.String rivaldevelsituation;
	/**
	 * �߿��ɼ�
	 */
	public java.lang.String gkgrade;
	/**
	 * �����
	 */
	public java.lang.Integer intedegree;
	/**
	 * ��������˵��
	 */
	public java.lang.String specialnote;
	/**
	 * �ϲ㵥������
	 */
	public String pk_school;
	/**
	 * ʱ���
	 */
	...
	/**
	 * ���� pk_visit��Getter����.���������ݷü�¼���� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_visit() {
		return this.pk_visit;
	}

	/**
	 * ����pk_visit��Setter����.���������ݷü�¼���� ��������:2021-7-21
	 * 
	 * @param newPk_visit java.lang.String
	 */
	public void setPk_visit(java.lang.String pk_visit) {
	...
	/**
	 * ���� busilevel��Getter����.��������ѧУ���񼶱� ��������:2021-7-21
	 * 
	 * @return nc.vo.cy.cyenum.BusilevelEnum
	 */
	public java.lang.Integer getBusilevel() {
		return this.busilevel;
	}

	/**
	 * ����busilevel��Setter����.��������ѧУ���񼶱� ��������:2021-7-21
	 * 
	 * @param newBusilevel nc.vo.cy.cyenum.BusilevelEnum
	 */
	public void setBusilevel(java.lang.Integer busilevel) {
		this.busilevel = busilevel;
	}

	/**
	 * ���� develsituation��Getter����.������������˾������� ��������:2021-7-21
	 * 
	 * @return nc.vo.pub.lang.UFUFBoolean
	 */
	public UFBoolean getDevelsituation() {
		return this.develsituation;
	}

	/**
	 * ����develsituation��Setter����.������������˾������� ��������:2021-7-21
	 * 
	 * @param newDevelsituation nc.vo.pub.lang.UFUFBoolean
	 */
	public void setDevelsituation(UFBoolean develsituation) {
		this.develsituation = develsituation;
	}

	/**
	 * ���� gradenum��Getter����.�����������꼶���� ��������:2021-7-21
	 * 
	...
	/**
	 * ����competitor��Setter����.���������������� ��������:2021-7-21
	 * 
	 * @param newCompetitor java.lang.String
	 */
	...
	/**
	 * ���� rivaldevelsituation��Getter����.�����������������������
	 * ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getRivaldevelsituation() {
		return this.rivaldevelsituation;
	}

	/**
	 * ����rivaldevelsituation��Setter����.�����������������������
	 * ��������:2021-7-21
	 * 
	 * @param newRivaldevelsituation java.lang.String
	 */
	public void setRivaldevelsituation(java.lang.String rivaldevelsituation) {
		this.rivaldevelsituation = rivaldevelsituation;
	}

	/**
	 * ���� gkgrade��Getter����.���������߿��ɼ� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getGkgrade() {
		return this.gkgrade;
	}

	/**
	 * ����gkgrade��Setter����.���������߿��ɼ� ��������:2021-7-21
	 * 
	 * @param newGkgrade java.lang.String
	 */
	public void setGkgrade(java.lang.String gkgrade) {
		this.gkgrade = gkgrade;
	}

	/**
	 * ���� intedegree��Getter����.������������� ��������:2021-7-21
	 * 
	 * @return nc.vo.cy.cyenum.IntedegreeEnum
	 */
	public java.lang.Integer getIntedegree() {
		return this.intedegree;
	}

	/**
	 * ����intedegree��Setter����.������������� ��������:2021-7-21
	 * 
	 * @param newIntedegree nc.vo.cy.cyenum.IntedegreeEnum
	 */
	public void setIntedegree(java.lang.Integer intedegree) {
		this.intedegree = intedegree;
	}

	/**
	 * ���� specialnote��Getter����.����������������˵�� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����specialnote��Setter����.����������������˵�� ��������:2021-7-21
	 * 
	 * @param newSpecialnote java.lang.String
	 */
	...
	public String getPk_school() {
		return this.pk_school;
	}

	/**
	 * ���������ϲ�������Setter����.���������ϲ����� ��������:2021-7-21
	 * 
	 * @param newPk_school String
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.schoolBasicsVisitVO");
	}
}
