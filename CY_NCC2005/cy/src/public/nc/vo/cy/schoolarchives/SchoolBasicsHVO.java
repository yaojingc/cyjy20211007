...
public class SchoolBasicsHVO extends SuperVO {
	
/**
*ѧУ������Ϣ����
*/
public java.lang.String pk_school;
/**
*����
*/
...
*��������
*/
public java.lang.Integer develprocess;
/**
*ѧУ����ص�
*/
...
*ѧУ�绰
*/
public java.lang.String sphone;
/**
*��������
*/
...
*����ҵ��Ա
*/
public java.lang.String saleman;
/**
*�����߹�
*/
public java.lang.String senior;
/**
*ʱ���
*/
...
/**
* ���� pk_school��Getter����.��������ѧУ������Ϣ����
*  ��������:2021-8-10
* @return java.lang.String
*/
public java.lang.String getPk_school() {
return this.pk_school;
} 

/**
* ����pk_school��Setter����.��������ѧУ������Ϣ����
* ��������:2021-8-10
* @param newPk_school java.lang.String
*/
public void setPk_school ( java.lang.String pk_school) {
...
* ����country��Setter����.������������
* ��������:2021-8-10
* @param newCountry nc.vo.bd.countryzone.CountryZoneVO
*/
...
* ���� province��Getter����.��������ʡ
*  ��������:2021-8-10
* @return nc.vo.bd.region.RegionVO
*/
...
* ����province��Setter����.��������ʡ
* ��������:2021-8-10
* @param newProvince nc.vo.bd.region.RegionVO
*/
...
* ����city��Setter����.����������
* ��������:2021-8-10
* @param newCity nc.vo.bd.region.RegionVO
*/
...
* ����county��Setter����.����������
* ��������:2021-8-10
* @param newCounty nc.vo.bd.region.RegionVO
*/
...
* ���� develprocess��Getter����.����������������
*  ��������:2021-8-10
* @return nc.vo.cy.cyenum.DevelProcessEnum
*/
public java.lang.Integer getDevelprocess() {
return this.develprocess;
} 

/**
* ����develprocess��Setter����.����������������
* ��������:2021-8-10
* @param newDevelprocess nc.vo.cy.cyenum.DevelProcessEnum
*/
public void setDevelprocess ( java.lang.Integer develprocess) {
this.develprocess=develprocess;
} 
 
/**
* ���� saddress��Getter����.��������ѧУ����ص�
*  ��������:2021-8-10
* @return java.lang.String
*/
...
* ����sphone��Setter����.��������ѧУ�绰
* ��������:2021-8-10
* @param newSphone java.lang.String
*/
...
* ���� region��Getter����.����������������
*  ��������:2021-8-10
* @return nc.vo.cy.cyenum.AreaEnum
*/
...
* ����region��Setter����.����������������
* ��������:2021-8-10
* @param newRegion nc.vo.cy.cyenum.AreaEnum
*/
...
* ����saleman��Setter����.������������ҵ��Ա
* ��������:2021-8-10
* @param newSaleman nc.vo.bd.psn.PsndocVO
*/
...
* @return nc.vo.bd.psn.PsndocVO
*/
public java.lang.String getSenior() {
return this.senior;
} 
...
* ����senior��Setter����.�������������߹�
* ��������:2021-8-10
* @param newSenior nc.vo.bd.psn.PsndocVO
*/
public void setSenior ( java.lang.String senior) {
this.senior=senior;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.schoolBasicsHVO");
    }
   }
