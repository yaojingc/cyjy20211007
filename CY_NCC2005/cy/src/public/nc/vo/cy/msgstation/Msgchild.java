...
public class Msgchild extends SuperVO {
	
/**
*��Ϣ��תվ�ӱ�����
*/
public java.lang.String pk_msgchild;
/**
*�Զ�����1
*/
...
/**
* ���� pk_msgchild��Getter����.����������Ϣ��תվ�ӱ�����
*  ��������:2021-8-5
* @return java.lang.String
*/
public java.lang.String getPk_msgchild() {
return this.pk_msgchild;
} 

/**
* ����pk_msgchild��Setter����.����������Ϣ��תվ�ӱ�����
* ��������:2021-8-5
* @param newPk_msgchild java.lang.String
*/
public void setPk_msgchild ( java.lang.String pk_msgchild) {
this.pk_msgchild=pk_msgchild;
} 
...
/**
* ���� status��Getter����.��������vostatus
*  ��������:2021-8-5
* @return java.lang.Integer
*/
public  int getStatus() {
return (java.lang.Integer) this.getAttributeValue( Msgchild.STATUS);
} 

/**
* ����status��Setter����.��������vostatus
* ��������:2021-8-5
* @param newStatus java.lang.Integer
*/
public void setStatus ( java.lang.Integer status) {
this.setAttributeValue( Msgchild.STATUS,status);
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.msgchild");
    }
   }
