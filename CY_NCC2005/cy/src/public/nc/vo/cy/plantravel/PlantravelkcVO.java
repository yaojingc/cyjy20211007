...
public class PlantravelkcVO extends SuperVO {
	
/**
*考察效果维护主键
*/
public java.lang.String pk_kceffect;
/**
*行号
*/
...
*考察效果维护
*/
public java.lang.String effectmaintain;
/**
*预计启动时间
*/
public java.lang.String prestartdate;
/**
*情况说明
*/
...
/**
* 属性 pk_kceffect的Getter方法.属性名：考察效果维护主键
*  创建日期:2021-9-10
* @return java.lang.String
*/
public java.lang.String getPk_kceffect() {
return this.pk_kceffect;
} 

/**
* 属性pk_kceffect的Setter方法.属性名：考察效果维护主键
* 创建日期:2021-9-10
* @param newPk_kceffect java.lang.String
*/
public void setPk_kceffect ( java.lang.String pk_kceffect) {
...
/**
* 属性 effectmaintain的Getter方法.属性名：考察效果维护
*  创建日期:2021-9-10
* @return java.lang.String
*/
public java.lang.String getEffectmaintain() {
return this.effectmaintain;
} 

/**
* 属性effectmaintain的Setter方法.属性名：考察效果维护
* 创建日期:2021-9-10
* @param newEffectmaintain java.lang.String
*/
public void setEffectmaintain ( java.lang.String effectmaintain) {
this.effectmaintain=effectmaintain;
} 
 
/**
* 属性 prestartdate的Getter方法.属性名：预计启动时间
*  创建日期:2021-9-10
* @return java.lang.String
*/
public java.lang.String getPrestartdate() {
return this.prestartdate;
} 

/**
* 属性prestartdate的Setter方法.属性名：预计启动时间
* 创建日期:2021-9-10
* @param newPrestartdate java.lang.String
*/
public void setPrestartdate ( java.lang.String prestartdate) {
this.prestartdate=prestartdate;
} 
 
/**
* 属性 infonote的Getter方法.属性名：情况说明
*  创建日期:2021-9-10
* @return java.lang.String
*/
...
return this.pk_plantravel;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2021-9-10
* @param newPk_plantravel String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.plantravelkcVO");
    }
   }
