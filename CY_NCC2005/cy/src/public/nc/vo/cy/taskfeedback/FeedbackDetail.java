...
public class FeedbackDetail extends SuperVO {
...
/**
* 属性 pk_detail的Getter方法.属性名：任务指派反馈详情主键
*  创建日期:2021-9-3
...
/**
* 属性pk_detail的Setter方法.属性名：任务指派反馈详情主键
* 创建日期:2021-9-3
...
* 创建日期:2021-9-3
* @param newPk_taskfeedback String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.feedbackDetail");
    }
   }
