 ...
 * </p>
 *  ��������:2021-8-13
 * @author Add By huangcong 学费减免申请单主表VO
 * @version NCPrj ??
 */
 
public class XuefeijmHVO extends SuperVO {
	
/**
*ѧ�Ѽ������뵥����
*/
public java.lang.String pk_xfapply;
/**
*����
*/
...
*��Դ�����к�
*/
public java.lang.String srcrowno0;
/**
*��Դ��������
*/
...
*ѧ���ܽ��
*/
public nc.vo.pub.lang.UFDouble alltuition;
/**
*������
*/
public nc.vo.pub.lang.UFDouble reducation;
/**
*Ӧ�ɽ��
*/
...
*��������
*/
public java.lang.String freetype;
/**
*����˵��
*/
public java.lang.String infonote;
...
*ѧУ������ַ
*/
public java.lang.String saddress;
/**
*�����Ƿ��ϴ�
*/
public UFBoolean isupload;
/**
*�Զ�����1
*/
...
/**
* ���� pk_xfapply��Getter����.��������ѧ�Ѽ������뵥����
*  ��������:2021-8-13
* @return java.lang.String
*/
public java.lang.String getPk_xfapply() {
return this.pk_xfapply;
} 

/**
* ����pk_xfapply��Setter����.��������ѧ�Ѽ������뵥����
* ��������:2021-8-13
* @param newPk_xfapply java.lang.String
*/
public void setPk_xfapply ( java.lang.String pk_xfapply) {
...
/**
* ���� srcrowno0��Getter����.����������Դ�����к�
*  ��������:2021-8-13
* @return java.lang.String
*/
public java.lang.String getSrcrowno0() {
return this.srcrowno0;
} 

/**
* ����srcrowno0��Setter����.����������Դ�����к�
* ��������:2021-8-13
* @param newSrcrowno0 java.lang.String
*/
public void setSrcrowno0 ( java.lang.String srcrowno0) {
this.srcrowno0=srcrowno0;
} 
...
/**
* ���� alltuition��Getter����.��������ѧ���ܽ��
*  ��������:2021-8-13
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getAlltuition() {
return this.alltuition;
} 

/**
* ����alltuition��Setter����.��������ѧ���ܽ��
* ��������:2021-8-13
* @param newAlltuition nc.vo.pub.lang.UFDouble
*/
public void setAlltuition ( nc.vo.pub.lang.UFDouble alltuition) {
...
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getReducation() {
...
* ����reducation��Setter����.��������������
* ��������:2021-8-13
* @param newReducation nc.vo.pub.lang.UFDouble
*/
public void setReducation ( nc.vo.pub.lang.UFDouble reducation) {
...
* @return java.lang.String
*/
public java.lang.String getFreetype() {
...
* ����freetype��Setter����.����������������
* ��������:2021-8-13
* @param newFreetype java.lang.String
*/
public void setFreetype ( java.lang.String freetype) {
...
* @return java.lang.String
*/
public java.lang.String getInfonote() {
...
* ����infonote��Setter����.������������˵��
* ��������:2021-8-13
* @param newInfonote java.lang.String
*/
public void setInfonote ( java.lang.String infonote) {
this.infonote=infonote;
} 
 
/**
* ���� saddress��Getter����.��������ѧУ������ַ
*  ��������:2021-8-13
* @return java.lang.String
*/
...
/**
* ����saddress��Setter����.��������ѧУ������ַ
* ��������:2021-8-13
* @param newSaddress java.lang.String
*/
...
* ����isupload��Setter����.�������������Ƿ��ϴ�
* ��������:2021-8-13
* @param newIsupload nc.vo.pub.lang.UFUFBoolean
*/
public void setIsupload ( UFBoolean isupload) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.xuefeijmHVO");
    }
   }
