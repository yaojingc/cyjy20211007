...
public class XuefeiBVO extends SuperVO {
	
/**
*学费减免子表主键
*/
public java.lang.String pk_xfd;
/**
*行号
*/
...
/**
* 属性 pk_xfd的Getter方法.属性名：学费减免子表主键
*  创建日期:2021-8-13
* @return java.lang.String
*/
public java.lang.String getPk_xfd() {
return this.pk_xfd;
} 

/**
* 属性pk_xfd的Setter方法.属性名：学费减免子表主键
* 创建日期:2021-8-13
* @param newPk_xfd java.lang.String
*/
public void setPk_xfd ( java.lang.String pk_xfd) {
this.pk_xfd=pk_xfd;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.xuefeiBVO");
    }
   }
