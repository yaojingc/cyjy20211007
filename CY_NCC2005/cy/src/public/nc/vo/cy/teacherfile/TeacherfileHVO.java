...
public class TeacherfileHVO extends SuperVO {
	 ...
	 * ��ʦ��������
	 */
	public java.lang.String pk_teachfile;
	/**
	 * ����
	 */
	 ...
	 * �������
	 */
	public java.lang.String interview;
	/**
	 * ��һ���Խ�
	 */
	public java.lang.String firsttest;
	/**
	 * ���ϵ�һ��ĥ��
	 */
	public java.lang.String firstteach;
	/**
	 * �ڶ����Խ�
	 */
	public java.lang.String secondtest;
	/**
	 * �ڶ���ĥ��
	 */
	public java.lang.String secondteach;
	/**
	 * ����߿��ɼ�
	 */
	public nc.vo.pub.lang.UFDouble performance;
	/**
	 * ʱ���
	 */
	...
	/**
	 * ���� pk_teachfile��Getter����.����������ʦ�������� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_teachfile() {
		return this.pk_teachfile;
	}

	/**
	 * ����pk_teachfile��Setter����.����������ʦ�������� ��������:2021-6-22
	 * 
	 * @param newPk_teachfile java.lang.String
	 */
	public void setPk_teachfile(java.lang.String pk_teachfile) {
		this.pk_teachfile = pk_teachfile;
	}

	/**
	 * ���� pk_group��Getter����.������������ ��������:2021-6-22
	 * 
	...
	/**
	 * ���� pk_busitype��Getter����.��������ҵ������ ��������:2021-6-22
	 * 
	...
	/**
	 * ����pk_busitype��Setter����.��������ҵ������ ��������:2021-6-22
	 * 
	...
	/**
	 * ���� pk_billtypeid��Getter����.���������������� ��������:2021-6-22
	 * 
	...
	/**
	 * ����pk_billtypeid��Setter����.���������������� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� transtypecode��Getter����.���������������ͱ��� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����transtypecode��Setter����.���������������ͱ��� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� creationtime��Getter����.������������ʱ�� ��������:2021-6-22
	 * 
	...
	/**
	 * ����creationtime��Setter����.������������ʱ�� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� modifiedtime��Getter����.���������޸�ʱ�� ��������:2021-6-22
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	/**
	 * ����modifiedtime��Setter����.���������޸�ʱ�� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� approvestatus��Getter����.������������״̬ ��������:2021-6-22
	 * 
	 * @return nc.vo.pub.pf.BillStatusEnum
	 */
	...
	/**
	 * ����approvestatus��Setter����.������������״̬ ��������:2021-6-22
	 * 
	...
	/**
	 * ���� approvedate��Getter����.������������ʱ�� ��������:2021-6-22
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	/**
	 * ����approvedate��Setter����.������������ʱ�� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� srcbilltype��Getter����.����������Դ�������� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srcbilltype��Setter����.����������Դ�������� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� srcbillid��Getter����.����������Դ����id ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srcbillid��Setter����.����������Դ����id ��������:2021-6-22
	 * 
	...
	/**
	 * ���� srcbid��Getter����.����������Դ�����ӱ�id ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srcbid��Setter����.����������Դ�����ӱ�id ��������:2021-6-22
	 * 
	...
	/**
	 * ���� srctrantype��Getter����.����������Դ�������� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srctrantype��Setter����.����������Դ�������� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� vfirsttype��Getter����.��������Դͷ�������� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirsttype��Setter����.��������Դͷ�������� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� vfirstcode��Getter����.��������Դͷ���ݺ� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstcode��Setter����.��������Դͷ���ݺ� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� vfirstid��Getter����.��������Դͷ��������id ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstid��Setter����.��������Դͷ��������id ��������:2021-6-22
	 * 
	...
	/**
	 * ���� vfirstbid��Getter����.��������Դͷ�����ӱ�id ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstbid��Setter����.��������Դͷ�����ӱ�id ��������:2021-6-22
	 * 
	...
	/**
	 * ���� vfirstrowno��Getter����.��������Դͷ�����к� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstrowno��Setter����.��������Դͷ�����к� ��������:2021-6-22
	 * 
	...
	/**
	 * ���� vfirsttrantype��Getter����.��������Դͷ�������� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirsttrantype��Setter����.��������Դͷ�������� ��������:2021-6-22
	 * 
	...
	/**
	 * ����intro��Setter����.����������� ��������:2021-6-22
	 * 
	 * @param newIntro java.lang.String
	 */
	...
	/**
	 * ����interview��Setter����.��������������� ��������:2021-6-22
	 * 
	 * @param newInterview java.lang.String
	 */
	...
	/**
	 * ���� firsttest��Getter����.����������һ���Խ� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����firsttest��Setter����.����������һ���Խ� ��������:2021-6-22
	 * 
	 * @param newFirsttest java.lang.String
	 */
	public void setFirsttest(java.lang.String firsttest) {
		this.firsttest = firsttest;
	}

	/**
	 * ���� firstteach��Getter����.�����������ϵ�һ��ĥ�� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getFirstteach() {
		return this.firstteach;
	}

	/**
	 * ����firstteach��Setter����.�����������ϵ�һ��ĥ�� ��������:2021-6-22
	 * 
	 * @param newFirstteach java.lang.String
	 */
	public void setFirstteach(java.lang.String firstteach) {
		this.firstteach = firstteach;
	}

	/**
	 * ���� secondtest��Getter����.���������ڶ����Խ� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����secondtest��Setter����.���������ڶ����Խ� ��������:2021-6-22
	 * 
	 * @param newSecondtest java.lang.String
	 */
	public void setSecondtest(java.lang.String secondtest) {
		this.secondtest = secondtest;
	}

	/**
	 * ���� secondteach��Getter����.���������ڶ���ĥ�� ��������:2021-6-22
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getSecondteach() {
		return this.secondteach;
	}

	/**
	 * ����secondteach��Setter����.���������ڶ���ĥ�� ��������:2021-6-22
	 * 
	 * @param newSecondteach java.lang.String
	 */
	public void setSecondteach(java.lang.String secondteach) {
		this.secondteach = secondteach;
	}

	/**
	 * ���� performance��Getter����.������������߿��ɼ� ��������:2021-6-22
	 * 
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getPerformance() {
		return this.performance;
	}

	/**
	 * ����performance��Setter����.������������߿��ɼ� ��������:2021-6-22
	 * 
	 * @param newPerformance nc.vo.pub.lang.UFDouble
	 */
	public void setPerformance(nc.vo.pub.lang.UFDouble performance) {
		this.performance = performance;
	}

	/**
	 * ���� ����ʱ�����Getter����.��������ʱ��� ��������:2021-6-22
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.teacherfileHVO");
	}
}
