...
public class WorkplanbVO extends SuperVO {
	
/**
*�����ƻ��ӱ�����
*/
public java.lang.String pk_workplan_b;
/**
*�к�
*/
...
/**
* ���� pk_workplan_b��Getter����.�������������ƻ��ӱ�����
*  ��������:2021-8-23
* @return java.lang.String
*/
public java.lang.String getPk_workplan_b() {
return this.pk_workplan_b;
} 

/**
* ����pk_workplan_b��Setter����.�������������ƻ��ӱ�����
* ��������:2021-8-23
* @param newPk_workplan_b java.lang.String
*/
public void setPk_workplan_b ( java.lang.String pk_workplan_b) {
...
* ����visitdate��Setter����.���������ݷ�����
* ��������:2021-8-23
* @param newVisitdate nc.vo.pub.lang.UFDate
*/
public void setVisitdate ( UFDate visitdate) {
...
* ����week��Setter����.������������
* ��������:2021-8-23
* @param newWeek java.lang.String
*/
...
return this.pk_workplan;
}
/**
* ���������ϲ�������Setter����.���������ϲ�����
* ��������:2021-8-23
* @param newPk_workplan String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.workplanbVO");
    }
   }
