...
public class TeacherformDetailVO extends SuperVO {
...
* 创建日期:2021-8-23
* @param newPk_teacherform String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.teacherformDetailVO");
    }
   }
