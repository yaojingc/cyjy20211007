...
public class TeacherformHVO extends SuperVO {
	
/**
*��ʦ���뵥����
*/
public java.lang.String pk_teacherform;
/**
*����
*/
...
*������ʦ����
*/
public java.lang.Integer teachertype;
/**
*��Դ�༶
*/
public java.lang.String classcy;
/**
*����ʱ��
*/
public UFDateTime arrivaldate;
/**
*��ʼʱ��
*/
...
*�༶����
*/
public java.lang.Integer classnum;
/**
*�����꼶
*/
public java.lang.String ageclass;
/**
*ʦ������
*/
public java.lang.Integer teacherapply;
/**
*�����λ����Ƿ����
*/
public UFBoolean ctmeeting;
/**
*�ҳ������Ƿ����
*/
public UFBoolean ptmeeting;
/**
*ѧ�������Ƿ����
*/
public UFBoolean stmeeting;
/**
*��һ��ѧ��������ʦ�ʴ���������
*/
public java.lang.String teacherinfos;
/**
*Ԥ����������
*/
public java.lang.Integer predictpsn;
/**
*����ʦ������
*/
public java.lang.Integer teachernum;
/**
*�Ƿ���Ҫ����ס��
*/
public UFBoolean putup;
/**
*�¿����Ӧ�ɷѹ�˾
*/
public java.lang.String paycompany;
/**
*��ʦ����
*/
...
*�䶯���Դ�༶
*/
public java.lang.String classcyafter;
/**
*��������˵��
*/
public java.lang.String workitems;
/**
*ʱ���
*/
...
/**
* ���� pk_teacherform��Getter����.����������ʦ���뵥����
*  ��������:2021-8-23
* @return java.lang.String
*/
public java.lang.String getPk_teacherform() {
return this.pk_teacherform;
} 

/**
* ����pk_teacherform��Setter����.����������ʦ���뵥����
* ��������:2021-8-23
* @param newPk_teacherform java.lang.String
*/
public void setPk_teacherform ( java.lang.String pk_teacherform) {
...
/**
* ���� teachertype��Getter����.��������������ʦ����
*  ��������:2021-8-23
* @return nc.vo.cy.cyenum.TeacherEnum
*/
public java.lang.Integer getTeachertype() {
return this.teachertype;
} 

/**
* ����teachertype��Setter����.��������������ʦ����
* ��������:2021-8-23
* @param newTeachertype nc.vo.cy.cyenum.TeacherEnum
*/
public void setTeachertype ( java.lang.Integer teachertype) {
...
* @return java.lang.String
*/
public java.lang.String getClasscy() {
return this.classcy;
} 
...
* ����classcy��Setter����.����������Դ�༶
* ��������:2021-8-23
* @param newClasscy java.lang.String
*/
public void setClasscy ( java.lang.String classcy) {
this.classcy=classcy;
} 
 
/**
* ���� arrivaldate��Getter����.������������ʱ��
*  ��������:2021-8-23
* @return nc.vo.pub.lang.UFDateTime
*/
public UFDateTime getArrivaldate() {
return this.arrivaldate;
} 

/**
* ����arrivaldate��Setter����.������������ʱ��
* ��������:2021-8-23
* @param newArrivaldate nc.vo.pub.lang.UFDateTime
*/
public void setArrivaldate ( UFDateTime arrivaldate) {
...
*/
public java.lang.Integer getClassnum() {
...
* ����classnum��Setter����.���������༶����
* ��������:2021-8-23
* @param newClassnum java.lang.Integer
*/
public void setClassnum ( java.lang.Integer classnum) {
...
* ����ageclass��Setter����.�������������꼶
* ��������:2021-8-23
* @param newAgeclass java.lang.String
*/
...
/**
* ���� teacherapply��Getter����.��������ʦ������
*  ��������:2021-8-23
* @return nc.vo.cy.cyenum.FacultyEnum
*/
public java.lang.Integer getTeacherapply() {
return this.teacherapply;
} 

/**
* ����teacherapply��Setter����.��������ʦ������
* ��������:2021-8-23
* @param newTeacherapply nc.vo.cy.cyenum.FacultyEnum
*/
public void setTeacherapply ( java.lang.Integer teacherapply) {
this.teacherapply=teacherapply;
} 
 
/**
* ���� ctmeeting��Getter����.�������������λ����Ƿ����
*  ��������:2021-8-23
* @return nc.vo.pub.lang.UFUFBoolean
*/
public UFBoolean getCtmeeting() {
return this.ctmeeting;
} 

/**
* ����ctmeeting��Setter����.�������������λ����Ƿ����
* ��������:2021-8-23
* @param newCtmeeting nc.vo.pub.lang.UFUFBoolean
*/
public void setCtmeeting ( UFBoolean ctmeeting) {
this.ctmeeting=ctmeeting;
} 
 
/**
* ���� ptmeeting��Getter����.���������ҳ������Ƿ����
*  ��������:2021-8-23
* @return nc.vo.pub.lang.UFUFBoolean
*/
public UFBoolean getPtmeeting() {
return this.ptmeeting;
} 

/**
* ����ptmeeting��Setter����.���������ҳ������Ƿ����
* ��������:2021-8-23
* @param newPtmeeting nc.vo.pub.lang.UFUFBoolean
*/
public void setPtmeeting ( UFBoolean ptmeeting) {
this.ptmeeting=ptmeeting;
} 
 
/**
* ���� stmeeting��Getter����.��������ѧ�������Ƿ����
*  ��������:2021-8-23
* @return nc.vo.pub.lang.UFUFBoolean
*/
public UFBoolean getStmeeting() {
return this.stmeeting;
} 

/**
* ����stmeeting��Setter����.��������ѧ�������Ƿ����
* ��������:2021-8-23
* @param newStmeeting nc.vo.pub.lang.UFUFBoolean
*/
public void setStmeeting ( UFBoolean stmeeting) {
this.stmeeting=stmeeting;
} 
 
/**
* ���� teacherinfos��Getter����.����������һ��ѧ��������ʦ�ʴ���������
*  ��������:2021-8-23
* @return java.lang.String
*/
public java.lang.String getTeacherinfos() {
return this.teacherinfos;
} 

/**
* ����teacherinfos��Setter����.����������һ��ѧ��������ʦ�ʴ���������
* ��������:2021-8-23
* @param newTeacherinfos java.lang.String
*/
public void setTeacherinfos ( java.lang.String teacherinfos) {
...
* @return java.lang.Integer
*/
public java.lang.Integer getPredictpsn() {
return this.predictpsn;
} 

/**
* ����predictpsn��Setter����.��������Ԥ����������
* ��������:2021-8-23
* @param newPredictpsn java.lang.Integer
*/
public void setPredictpsn ( java.lang.Integer predictpsn) {
...
* @return java.lang.Integer
*/
public java.lang.Integer getTeachernum() {
...
* ����teachernum��Setter����.������������ʦ������
* ��������:2021-8-23
* @param newTeachernum java.lang.Integer
*/
public void setTeachernum ( java.lang.Integer teachernum) {
...
* ����putup��Setter����.���������Ƿ���Ҫ����ס��
* ��������:2021-8-23
* @param newPutup nc.vo.pub.lang.UFUFBoolean
*/
public void setPutup ( UFBoolean putup) {
this.putup=putup;
} 
 
/**
* ���� paycompany��Getter����.���������¿����Ӧ�ɷѹ�˾
*  ��������:2021-8-23
* @return java.lang.String
*/
...
/**
* ����paycompany��Setter����.���������¿����Ӧ�ɷѹ�˾
* ��������:2021-8-23
* @param newPaycompany java.lang.String
*/
...
/**
* ���� classcyafter��Getter����.���������䶯���Դ�༶
*  ��������:2021-8-23
* @return java.lang.String
*/
public java.lang.String getClasscyafter() {
return this.classcyafter;
} 

/**
* ����classcyafter��Setter����.���������䶯���Դ�༶
* ��������:2021-8-23
* @param newClasscyafter java.lang.String
*/
public void setClasscyafter ( java.lang.String classcyafter) {
...
* @return java.lang.String
*/
public java.lang.String getWorkitems() {
...
* ����workitems��Setter����.����������������˵��
* ��������:2021-8-23
* @param newWorkitems java.lang.String
*/
public void setWorkitems ( java.lang.String workitems) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.teacherformHVO");
    }
   }
