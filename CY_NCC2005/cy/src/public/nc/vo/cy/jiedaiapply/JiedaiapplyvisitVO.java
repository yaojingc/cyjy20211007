...
public class JiedaiapplyvisitVO extends SuperVO {
	
/**
*������Ա��Ϣ����
*/
public java.lang.String pk_visitor;
/**
*�к�
*/
...
/**
* ���� pk_visitor��Getter����.��������������Ա��Ϣ����
*  ��������:2021-8-19
* @return java.lang.String
*/
public java.lang.String getPk_visitor() {
return this.pk_visitor;
} 

/**
* ����pk_visitor��Setter����.��������������Ա��Ϣ����
* ��������:2021-8-19
* @param newPk_visitor java.lang.String
*/
public void setPk_visitor ( java.lang.String pk_visitor) {
...
* ���� sex��Getter����.���������Ա�
*  ��������:2021-8-19
* @return nc.vohrhi.hrhi_psndoc_bad.enum
*/
...
* ����sex��Setter����.���������Ա�
* ��������:2021-8-19
* @param newSex nc.vohrhi.hrhi_psndoc_bad.enum
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.jiedaiapplyvisitVO");
    }
   }
