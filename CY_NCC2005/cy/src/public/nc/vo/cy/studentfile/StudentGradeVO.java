...
public class StudentGradeVO extends SuperVO {

	/**
	 * �ɼ���¼����
	 */
	public java.lang.String pk_grade;
	/**
	 * �к�
	 */
	...
	/**
	 * ���� pk_grade��Getter����.���������ɼ���¼���� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_grade() {
		return this.pk_grade;
	}

	/**
	 * ����pk_grade��Setter����.���������ɼ���¼���� ��������:2021-7-21
	 * 
	 * @param newPk_grade java.lang.String
	 */
	public void setPk_grade(java.lang.String pk_grade) {
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.studentGradeVO");
	}
}
