...
public class StudentChangeVO extends SuperVO {

	/**
	 * �䶯��¼����
	 */
	public java.lang.String pk_change;
	/**
	 * �к�
	 */
	 ...
	 * �䶯ǰ�����꼶
	 */
	public java.lang.String oldgrade;
	/**
	 * �䶯�������꼶
	 */
	public java.lang.String newgrade;
	/**
	 * �䶯ǰ���������༶
	 */
	public java.lang.String oldxzclass;
	/**
	 * �䶯�����������༶
	 */
	public java.lang.String newxzclass;
	/**
	 * �䶯ǰ��Դ���ڰ༶
	 */
	public java.lang.String oldcyclass;
	/**
	 * �䶯���Դ���ڰ༶
	 */
	public java.lang.String newcyclass;
	/**
	 * �䶯ǰѧ������
	 */
	public java.lang.String oldstudenttype;
	/**
	 * �䶯��ѧ������
	 */
	public java.lang.String newstudenttype;
	/**
	 * �ϲ㵥������
	 */
	...
	/**
	 * ���� pk_change��Getter����.���������䶯��¼���� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_change() {
		return this.pk_change;
	}

	/**
	 * ����pk_change��Setter����.���������䶯��¼���� ��������:2021-7-21
	 * 
	 * @param newPk_change java.lang.String
	 */
	public void setPk_change(java.lang.String pk_change) {
		this.pk_change = pk_change;
	}

	/**
	 * ���� rowno��Getter����.���������к� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ���� oldgrade��Getter����.���������䶯ǰ�����꼶 ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����oldgrade��Setter����.���������䶯ǰ�����꼶 ��������:2021-7-21
	 * 
	 * @param newOldgrade java.lang.String
	 */
	public void setOldgrade(java.lang.String oldgrade) {
		this.oldgrade = oldgrade;
	}

	/**
	 * ���� newgrade��Getter����.���������䶯�������꼶 ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����newgrade��Setter����.���������䶯�������꼶 ��������:2021-7-21
	 * 
	 * @param newNewgrade java.lang.String
	 */
	...
	/**
	 * ���� oldxzclass��Getter����.���������䶯ǰ���������༶ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getOldxzclass() {
		return this.oldxzclass;
	}

	/**
	 * ����oldxzclass��Setter����.���������䶯ǰ���������༶ ��������:2021-7-21
	 * 
	 * @param newOldxzclass java.lang.String
	 */
	public void setOldxzclass(java.lang.String oldxzclass) {
		this.oldxzclass = oldxzclass;
	}

	/**
	 * ���� newxzclass��Getter����.���������䶯�����������༶ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getNewxzclass() {
		return this.newxzclass;
	}

	/**
	 * ����newxzclass��Setter����.���������䶯�����������༶ ��������:2021-7-21
	 * 
	 * @param newNewxzclass java.lang.String
	 */
	public void setNewxzclass(java.lang.String newxzclass) {
		this.newxzclass = newxzclass;
	}

	/**
	 * ���� oldcyclass��Getter����.���������䶯ǰ��Դ���ڰ༶ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getOldcyclass() {
		return this.oldcyclass;
	}

	/**
	 * ����oldcyclass��Setter����.���������䶯ǰ��Դ���ڰ༶ ��������:2021-7-21
	 * 
	 * @param newOldcyclass java.lang.String
	 */
	public void setOldcyclass(java.lang.String oldcyclass) {
		this.oldcyclass = oldcyclass;
	}

	/**
	 * ���� newcyclass��Getter����.���������䶯���Դ���ڰ༶ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getNewcyclass() {
		return this.newcyclass;
	}

	/**
	 * ����newcyclass��Setter����.���������䶯���Դ���ڰ༶ ��������:2021-7-21
	 * 
	 * @param newNewcyclass java.lang.String
	 */
	public void setNewcyclass(java.lang.String newcyclass) {
		this.newcyclass = newcyclass;
	}

	/**
	 * ���� oldstudenttype��Getter����.���������䶯ǰѧ������ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getOldstudenttype() {
		return this.oldstudenttype;
	}

	/**
	 * ����oldstudenttype��Setter����.���������䶯ǰѧ������ ��������:2021-7-21
	 * 
	 * @param newOldstudenttype java.lang.String
	 */
	public void setOldstudenttype(java.lang.String oldstudenttype) {
		this.oldstudenttype = oldstudenttype;
	}

	/**
	 * ���� newstudenttype��Getter����.���������䶯��ѧ������ ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getNewstudenttype() {
		return this.newstudenttype;
	}

	/**
	 * ����newstudenttype��Setter����.���������䶯��ѧ������ ��������:2021-7-21
	 * 
	 * @param newNewstudenttype java.lang.String
	 */
	public void setNewstudenttype(java.lang.String newstudenttype) {
		this.newstudenttype = newstudenttype;
	}

	/**
	 * ���� �����ϲ�������Getter����.���������ϲ����� ��������:2021-7-21
	 * 
	 * @return String
	 */
	...
	/**
	 * ���������ϲ�������Setter����.���������ϲ����� ��������:2021-7-21
	 * 
	 * @param newPk_student String
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.studentChangeVO");
	}
}
