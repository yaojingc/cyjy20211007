...
public class StudentParentVO extends SuperVO {
	 ...
	 * �ҳ��ֻ���
	 */
	public java.lang.String parentphone;
	/**
	 * �ϲ㵥������
	 */
	...
	/**
	 * ���� pk_parent��Getter����.���������ҳ���Ϣ���� ��������:2021-7-21
	 * 
	...
	/**
	 * ����pk_parent��Setter����.���������ҳ���Ϣ���� ��������:2021-7-21
	 * 
	...
	/**
	 * ���� parentphone��Getter����.���������ҳ��ֻ��� ��������:2021-7-21
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����parentphone��Setter����.���������ҳ��ֻ��� ��������:2021-7-21
	 * 
	 * @param newParentphone java.lang.String
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.studentParentVO");
	}
}
