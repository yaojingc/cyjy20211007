...
public class ClasscyDetailVO extends SuperVO {
	...
	/**
	 * ���������ϲ�������Setter����.���������ϲ����� ��������:2021-7-29
	 * 
	 * @param newPk_classcy String
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.classcyDetailVO");
	}
}
