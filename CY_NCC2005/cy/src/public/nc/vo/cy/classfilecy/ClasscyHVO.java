...
public class ClasscyHVO extends SuperVO {

	/**
	 * 合同归属
	 */
	public java.lang.String contractowner;
	/**
	 * �༶����
	 */
	public java.lang.String pk_classcy;
	/**
	 * ����
	 */
	 ...
	 * ������ʦ
	 */
	public java.lang.String teacher;
	/**
	 * ���࿪ʼ����
	 */
	 ...
	 * �༶����
	 */
	public java.lang.Integer gradenum;
	/**
	 * С�鳤
	 */
	public java.lang.String gangboss;
	/**
	 * ����
	 */
	 ...
	 * �г�����
	 */
	public java.lang.String marketass;
	/**
	 * ҵ��Ա
	 */
	 ...
	 * ������
	 */
	public java.lang.String dutypsn;
	/**
	 * �༶����
	 */
	public java.lang.String clasname;
	/**
	 * �����꼶
	 */
	public java.lang.String openclas;
	/**
	 * �ɷѱ�׼
	 */
	public nc.vo.pub.lang.UFDouble paystand;
	/**
	 * �Ƿ�ǩ��ֽ��Э��
	 */
	public UFBoolean paperagre;
	/**
	 * �Ƿ����
	 */
	public UFBoolean isaverage;
	/**
	 * ��������
	 */
	public nc.vo.pub.lang.UFDouble artaverage;
	/**
	 * �Ļ�����
	 */
	public nc.vo.pub.lang.UFDouble culaverage;
	/**
	 * Ӣ�����
	 */
	public nc.vo.pub.lang.UFDouble engaverage;
	/**
	 * ����Ԥ��
	 */
	public nc.vo.pub.lang.UFDouble budget;
	/**
	 * �Ƿ�����
	 */
	...
	/**
	 * ���� pk_classcy��Getter����.���������༶���� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_classcy() {
		return this.pk_classcy;
	}

	/**
	 * ����pk_classcy��Setter����.���������༶���� ��������:2021-7-29
	 * 
	 * @param newPk_classcy java.lang.String
	 */
	public void setPk_classcy(java.lang.String pk_classcy) {
		this.pk_classcy = pk_classcy;
	}

	/**
	 * ���� pk_group��Getter����.������������ ��������:2021-7-29
	 * 
	...
	/**
	 * ���� pk_busitype��Getter����.��������ҵ������ ��������:2021-7-29
	 * 
	...
	/**
	 * ����pk_busitype��Setter����.��������ҵ������ ��������:2021-7-29
	 * 
	...
	/**
	 * ���� pk_billtypeid��Getter����.���������������� ��������:2021-7-29
	 * 
	...
	/**
	 * ����pk_billtypeid��Setter����.���������������� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� transtypecode��Getter����.���������������ͱ��� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����transtypecode��Setter����.���������������ͱ��� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� creationtime��Getter����.������������ʱ�� ��������:2021-7-29
	 * 
	...
	/**
	 * ����creationtime��Setter����.������������ʱ�� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� modifiedtime��Getter����.���������޸�ʱ�� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	/**
	 * ����modifiedtime��Setter����.���������޸�ʱ�� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� approvestatus��Getter����.������������״̬ ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.pf.BillStatusEnum
	 */
	...
	/**
	 * ����approvestatus��Setter����.������������״̬ ��������:2021-7-29
	 * 
	...
	/**
	 * ���� approvedate��Getter����.������������ʱ�� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	/**
	 * ����approvedate��Setter����.������������ʱ�� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� srcbilltype��Getter����.����������Դ�������� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srcbilltype��Setter����.����������Դ�������� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� srcbillid��Getter����.����������Դ����id ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srcbillid��Setter����.����������Դ����id ��������:2021-7-29
	 * 
	...
	/**
	 * ���� srcbid��Getter����.����������Դ�����ӱ�id ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srcbid��Setter����.����������Դ�����ӱ�id ��������:2021-7-29
	 * 
	...
	/**
	 * ���� srctrantype��Getter����.����������Դ�������� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srctrantype��Setter����.����������Դ�������� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� vfirsttype��Getter����.��������Դͷ�������� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirsttype��Setter����.��������Դͷ�������� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� vfirstcode��Getter����.��������Դͷ���ݺ� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstcode��Setter����.��������Դͷ���ݺ� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� vfirstid��Getter����.��������Դͷ��������id ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstid��Setter����.��������Դͷ��������id ��������:2021-7-29
	 * 
	...
	/**
	 * ���� vfirstbid��Getter����.��������Դͷ�����ӱ�id ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstbid��Setter����.��������Դͷ�����ӱ�id ��������:2021-7-29
	 * 
	...
	/**
	 * ���� vfirstrowno��Getter����.��������Դͷ�����к� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstrowno��Setter����.��������Դͷ�����к� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� vfirsttrantype��Getter����.��������Դͷ�������� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirsttrantype��Setter����.��������Դͷ�������� ��������:2021-7-29
	 * 
	...
	/**
	 * ���� school��Getter����.������������ѧУ ��������:2021-7-29
	 * 
	 * @return nc.vo.cy.schoolarchives.SchoolBasicsHVO
	 */
	...
	/**
	 * ����school��Setter����.������������ѧУ ��������:2021-7-29
	 * 
	 * @param newSchool nc.vo.cy.schoolarchives.SchoolBasicsHVO
	 */
	...
	/**
	 * ����teacher��Setter����.��������������ʦ ��������:2021-7-29
	 * 
	 * @param newTeacher nc.vo.bd.psn.PsndocVO
	 */
	...
	/**
	 * ����gradenum��Setter����.���������༶���� ��������:2021-7-29
	 * 
	 * @param newGradenum java.lang.Integer
	 */
	...
	/**
	 * ���� gangboss��Getter����.��������С�鳤 ��������:2021-7-29
	 * 
	 * @return nc.vo.bd.psn.PsndocVO
	 */
	public java.lang.String getGangboss() {
		return this.gangboss;
	}

	/**
	 * ����gangboss��Setter����.��������С�鳤 ��������:2021-7-29
	 * 
	 * @param newGangboss nc.vo.bd.psn.PsndocVO
	 */
	public void setGangboss(java.lang.String gangboss) {
		this.gangboss = gangboss;
	}

	/**
	 * ���� supervisor��Getter����.������������ ��������:2021-7-29
	 * 
	 * @return nc.vo.bd.psn.PsndocVO
	 */
	...
	/**
	 * ����supervisor��Setter����.������������ ��������:2021-7-29
	 * 
	 * @param newSupervisor nc.vo.bd.psn.PsndocVO
	 */
	...
	/**
	 * ���� marketass��Getter����.���������г����� ��������:2021-7-29
	 * 
	 * @return nc.vo.bd.psn.PsndocVO
	 */
	public java.lang.String getMarketass() {
		return this.marketass;
	}

	/**
	 * ����marketass��Setter����.���������г����� ��������:2021-7-29
	 * 
	 * @param newMarketass nc.vo.bd.psn.PsndocVO
	 */
	public void setMarketass(java.lang.String marketass) {
		this.marketass = marketass;
	}

	/**
	 * ���� salesman��Getter����.��������ҵ��Ա ��������:2021-7-29
	 * 
	 * @return nc.vo.bd.psn.PsndocVO
	 */
	...
	/**
	 * ���� dutypsn��Getter����.�������������� ��������:2021-7-29
	 * 
	 * @return nc.vo.bd.psn.PsndocVO
	 */
	public java.lang.String getDutypsn() {
		return this.dutypsn;
	}

	/**
	 * ����dutypsn��Setter����.�������������� ��������:2021-7-29
	 * 
	 * @param newDutypsn nc.vo.bd.psn.PsndocVO
	 */
	public void setDutypsn(java.lang.String dutypsn) {
		this.dutypsn = dutypsn;
	}

	/**
	 * ���� clasname��Getter����.���������༶���� ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����clasname��Setter����.���������༶���� ��������:2021-7-29
	 * 
	 * @param newClasname java.lang.String
	 */
	public void setClasname(java.lang.String clasname) {
		this.clasname = clasname;
	}

	/**
	 * ���� openclas��Getter����.�������������꼶 ��������:2021-7-29
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getOpenclas() {
		return this.openclas;
	}

	/**
	 * ����openclas��Setter����.�������������꼶 ��������:2021-7-29
	 * 
	 * @param newOpenclas java.lang.String
	 */
	public void setOpenclas(java.lang.String openclas) {
		this.openclas = openclas;
	}

	/**
	 * ���� paystand��Getter����.���������ɷѱ�׼ ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getPaystand() {
		return this.paystand;
	}

	/**
	 * ����paystand��Setter����.���������ɷѱ�׼ ��������:2021-7-29
	 * 
	 * @param newPaystand nc.vo.pub.lang.UFDouble
	 */
	public void setPaystand(nc.vo.pub.lang.UFDouble paystand) {
		this.paystand = paystand;
	}

	/**
	 * ���� paperagre��Getter����.���������Ƿ�ǩ��ֽ��Э�� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFBoolean
	 */
	public UFBoolean getPaperagre() {
		return this.paperagre;
	}

	/**
	 * ����paperagre��Setter����.���������Ƿ�ǩ��ֽ��Э�� ��������:2021-7-29
	 * 
	 * @param newPaperagre nc.vo.pub.lang.UFBoolean
	 */
	public void setPaperagre(UFBoolean paperagre) {
		this.paperagre = paperagre;
	}

	/**
	 * ���� isaverage��Getter����.���������Ƿ���� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFBoolean
	 */
	public UFBoolean getIsaverage() {
		return this.isaverage;
	}

	/**
	 * ����isaverage��Setter����.���������Ƿ���� ��������:2021-7-29
	 * 
	 * @param newIsaverage nc.vo.pub.lang.UFBoolean
	 */
	public void setIsaverage(UFBoolean isaverage) {
		this.isaverage = isaverage;
	}

	/**
	 * ���� artaverage��Getter����.���������������� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getArtaverage() {
		return this.artaverage;
	}

	/**
	 * ����artaverage��Setter����.���������������� ��������:2021-7-29
	 * 
	 * @param newArtaverage nc.vo.pub.lang.UFDouble
	 */
	public void setArtaverage(nc.vo.pub.lang.UFDouble artaverage) {
		this.artaverage = artaverage;
	}

	/**
	 * ���� culaverage��Getter����.���������Ļ����� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getCulaverage() {
		return this.culaverage;
	}

	/**
	 * ����culaverage��Setter����.���������Ļ����� ��������:2021-7-29
	 * 
	 * @param newCulaverage nc.vo.pub.lang.UFDouble
	 */
	public void setCulaverage(nc.vo.pub.lang.UFDouble culaverage) {
		this.culaverage = culaverage;
	}

	/**
	 * ���� engaverage��Getter����.��������Ӣ����� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getEngaverage() {
		return this.engaverage;
	}

	/**
	 * ����engaverage��Setter����.��������Ӣ����� ��������:2021-7-29
	 * 
	 * @param newEngaverage nc.vo.pub.lang.UFDouble
	 */
	public void setEngaverage(nc.vo.pub.lang.UFDouble engaverage) {
		this.engaverage = engaverage;
	}

	/**
	 * ���� budget��Getter����.������������Ԥ�� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getBudget() {
		return this.budget;
	}

	/**
	 * ����budget��Setter����.������������Ԥ�� ��������:2021-7-29
	 * 
	 * @param newBudget nc.vo.pub.lang.UFDouble
	 */
	public void setBudget(nc.vo.pub.lang.UFDouble budget) {
		this.budget = budget;
	}

	/**
	 * ���� isuseing��Getter����.���������Ƿ����� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFBoolean
	 */
	...
	/**
	 * ����isuseing��Setter����.���������Ƿ����� ��������:2021-7-29
	 * 
	 * @param newIsuseing nc.vo.pub.lang.UFBoolean
	 */
	...
	/**
	 * ���� contractowner��Getter����.����������ͬ���� ��������:2021-7-29
	 * 
	 * @return nc.vo.org.OrgVO
	 */
	public java.lang.String getContractowner() {
		return this.contractowner;
	}

	/**
	 * ����contractowner��Setter����.����������ͬ���� ��������:2021-7-29
	 * 
	 * @param newContractowner nc.vo.org.OrgVO
	 */
	public void setContractowner(java.lang.String contractowner) {
		this.contractowner = contractowner;
	}

	/**
	 * ���� ����ʱ�����Getter����.��������ʱ��� ��������:2021-7-29
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.classcyHVO");
	}
}
