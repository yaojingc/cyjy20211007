...
public class CreditcontractDetailVO extends SuperVO {

	/**
	 * ��ͬ��ϸ����
	 */
	public java.lang.String pk_detail;
	/**
	 * �к�
	 */
	 ...
	 * ���ں�
	 */
	public java.lang.String payno;
	/**
	 * �ƻ�����
	 */
	public java.lang.Integer proplan;
	/**
	 * ��������
	 */
	 ...
	 * ��������
	 */
	public java.lang.Integer paydays;
	/**
	 * �ƻ����
	 */
	public nc.vo.pub.lang.UFDouble planamount;
	/**
	 * �ϲ㵥������
	 */
	...
	/**
	 * ���� pk_detail��Getter����.����������ͬ��ϸ���� ��������:2021-7-30
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_detail() {
		return this.pk_detail;
	}

	/**
	 * ����pk_detail��Setter����.����������ͬ��ϸ���� ��������:2021-7-30
	 * 
	 * @param newPk_detail java.lang.String
	 */
	public void setPk_detail(java.lang.String pk_detail) {
		this.pk_detail = pk_detail;
	}

	/**
	 * ���� rowno��Getter����.���������к� ��������:2021-7-30
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ���� payno��Getter����.�����������ں� ��������:2021-7-30
	 * 
	 * @return nc.vo.bd.period.AccperiodVO
	 */
	...
	/**
	 * ����payno��Setter����.�����������ں� ��������:2021-7-30
	 * 
	 * @param newPayno nc.vo.bd.period.AccperiodVO
	 */
	...
	/**
	 * ���� proplan��Getter����.���������ƻ����� ��������:2021-7-30
	 * 
	 * @return java.lang.Integer
	 */
	public java.lang.Integer getProplan() {
		return this.proplan;
	}

	/**
	 * ����proplan��Setter����.���������ƻ����� ��������:2021-7-30
	 * 
	 * @param newProplan java.lang.Integer
	 */
	public void setProplan(java.lang.Integer proplan) {
		this.proplan = proplan;
	}

	/**
	 * ���� startdate��Getter����.���������������� ��������:2021-7-30
	 * 
	...
	/**
	 * ����paydays��Setter����.���������������� ��������:2021-7-30
	 * 
	 * @param newPaydays java.lang.Integer
	 */
	...
	/**
	 * ���� planamount��Getter����.���������ƻ���� ��������:2021-7-30
	 * 
	 * @return nc.vo.pub.lang.UFDouble
	 */
	public nc.vo.pub.lang.UFDouble getPlanamount() {
		return this.planamount;
	}

	/**
	 * ����planamount��Setter����.���������ƻ���� ��������:2021-7-30
	 * 
	 * @param newPlanamount nc.vo.pub.lang.UFDouble
	 */
	public void setPlanamount(nc.vo.pub.lang.UFDouble planamount) {
		this.planamount = planamount;
	}

	/**
	 * ���� �����ϲ�������Getter����.���������ϲ����� ��������:2021-7-30
	 * 
	 * @return String
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.creditcontractDetailVO");
	}
}
