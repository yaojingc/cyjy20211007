...
public class BankcollflowHVO extends SuperVO {

	public java.lang.String strkey;// 查询用 身份证号+￥+付款金额

	/**
	 * ������ˮ����
	 */
	public java.lang.String pk_bank;
	/**
	 * ����
	 */
	 ...
	 * �ɷ���Ŀ
	 */
	public java.lang.String payproject;
	/**
	 * �ɷѽ��
	 */
	public java.lang.String payamount;
	/**
	 * Ĭ��
	 */
	public java.lang.String acquiescent;
	/**
	 * ƥ��״̬
	 */
	public java.lang.String matchstate;
	/**
	 * �ɷ�����
	 */
	 ...
	 * ��Ʊ״̬
	 */
	public UFBoolean makestate;
	/**
	 * �ɷѵ���
	 */
	public java.lang.String paycode;
	/**
	 * �տ������˻�
	 */
	 ...
	 * �ɷѷ�ʽ
	 */
	public java.lang.String paytype;
	/**
	 * ʱ���
	 */
	...
	public void setStrkey(java.lang.String strkey) {
		this.strkey = strkey;
	}

	/**
	 * ���� pk_bank��Getter����.��������������ˮ���� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPk_bank() {
		return this.pk_bank;
	}

	/**
	 * ����pk_bank��Setter����.��������������ˮ���� ��������:2021-8-3
	 * 
	 * @param newPk_bank java.lang.String
	 */
	public void setPk_bank(java.lang.String pk_bank) {
		this.pk_bank = pk_bank;
	}

	/**
	 * ���� pk_group��Getter����.������������ ��������:2021-8-3
	 * 
	...
	/**
	 * ���� transtypecode��Getter����.���������������ͱ��� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����transtypecode��Setter����.���������������ͱ��� ��������:2021-8-3
	 * 
	...
	/**
	 * ���� creationtime��Getter����.������������ʱ�� ��������:2021-8-3
	 * 
	...
	/**
	 * ����creationtime��Setter����.������������ʱ�� ��������:2021-8-3
	 * 
	...
	/**
	 * ���� modifiedtime��Getter����.���������޸�ʱ�� ��������:2021-8-3
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	/**
	 * ����modifiedtime��Setter����.���������޸�ʱ�� ��������:2021-8-3
	 * 
	...
	/**
	 * ���� approvestatus��Getter����.������������״̬ ��������:2021-8-3
	 * 
	 * @return nc.vo.pub.pf.BillStatusEnum
	 */
	...
	/**
	 * ����approvestatus��Setter����.������������״̬ ��������:2021-8-3
	 * 
	...
	/**
	 * ���� srcbillid��Getter����.����������Դ����id ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����srcbillid��Setter����.����������Դ����id ��������:2021-8-3
	 * 
	...
	/**
	 * ���� vfirstcode��Getter����.��������Դͷ���ݺ� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstcode��Setter����.��������Դͷ���ݺ� ��������:2021-8-3
	 * 
	...
	/**
	 * ���� vfirstid��Getter����.��������Դͷ��������id ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstid��Setter����.��������Դͷ��������id ��������:2021-8-3
	 * 
	...
	/**
	 * ���� vfirstbid��Getter����.��������Դͷ�����ӱ�id ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstbid��Setter����.��������Դͷ�����ӱ�id ��������:2021-8-3
	 * 
	...
	/**
	 * ���� vfirstrowno��Getter����.��������Դͷ�����к� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirstrowno��Setter����.��������Դͷ�����к� ��������:2021-8-3
	 * 
	...
	/**
	 * ���� vfirsttrantype��Getter����.��������Դͷ�������� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����vfirsttrantype��Setter����.��������Դͷ�������� ��������:2021-8-3
	 * 
	...
	/**
	 * ����phonenum��Setter����.��������ѧ���ֻ��� ��������:2021-8-3
	 * 
	 * @param newPhonenum java.lang.String
	 */
	...
	/**
	 * ���� payproject��Getter����.���������ɷ���Ŀ ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getPayproject() {
		return this.payproject;
	}

	/**
	 * ����payproject��Setter����.���������ɷ���Ŀ ��������:2021-8-3
	 * 
	 * @param newPayproject java.lang.String
	 */
	public void setPayproject(java.lang.String payproject) {
		this.payproject = payproject;
	}

	/**
	 * ���� payamount��Getter����.���������ɷѽ�� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����payamount��Setter����.���������ɷѽ�� ��������:2021-8-3
	 * 
	 * @param newPayamount java.lang.String
	 */
	...
	/**
	 * ���� acquiescent��Getter����.��������Ĭ�� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	public java.lang.String getAcquiescent() {
		return this.acquiescent;
	}

	/**
	 * ����acquiescent��Setter����.��������Ĭ�� ��������:2021-8-3
	 * 
	 * @param newAcquiescent java.lang.String
	 */
	public void setAcquiescent(java.lang.String acquiescent) {
		this.acquiescent = acquiescent;
	}

	/**
	 * ���� matchstate��Getter����.��������ƥ��״̬ ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����matchstate��Setter����.��������ƥ��״̬ ��������:2021-8-3
	 * 
	 * @param newMatchstate java.lang.String
	 */
	public void setMatchstate(java.lang.String matchstate) {
		this.matchstate = matchstate;
	}

	/**
	 * ���� paydate��Getter����.���������ɷ����� ��������:2021-8-3
	 * 
	 * @return nc.vo.pub.lang.UFDateTime
	 */
	...
	/**
	 * ���� makestate��Getter����.����������Ʊ״̬ ��������:2021-8-3
	 * 
	 * @return nc.vo.pub.lang.UFBoolean
	 */
	public UFBoolean getMakestate() {
		return this.makestate;
	}

	/**
	 * ����makestate��Setter����.����������Ʊ״̬ ��������:2021-8-3
	 * 
	 * @param newMakestate nc.vo.pub.lang.UFBoolean
	 */
	public void setMakestate(UFBoolean makestate) {
		this.makestate = makestate;
	}

	/**
	 * ���� paycode��Getter����.���������ɷѵ��� ��������:2021-8-3
	 * 
	 * @return java.lang.String
	 */
	...
	/**
	 * ����paycode��Setter����.���������ɷѵ��� ��������:2021-8-3
	 * 
	 * @param newPaycode java.lang.String
	 */
	...
	/**
	 * ����bankaccount��Setter����.���������տ������˻� ��������:2021-8-3
	 * 
	 * @param newBankaccount nc.vo.bd.bankaccount.BankAccSubVO
	 */
	...
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("cy.bankcollflowHVO");
	}
}
