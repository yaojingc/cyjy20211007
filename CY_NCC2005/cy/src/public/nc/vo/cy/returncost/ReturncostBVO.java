...
public class ReturncostBVO extends SuperVO {
...
*行号
*/
public java.lang.String rowno0;
/**
*自定义项1
*/
...
/**
* 属性 pk_detail的Getter方法.属性名：明细主键
*  创建日期:2021-9-9
...
/**
* 属性rowno0的Setter方法.属性名：行号
* 创建日期:2021-9-9
* @param newRowno0 java.lang.String
*/
public void setRowno0 ( java.lang.String rowno0) {
this.rowno0=rowno0;
} 
...
* @return String
*/
public String getPk_returncost(){
return this.pk_returncost;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2021-9-9
* @param newPk_returncost String
*/
public void setPk_returncost(String pk_returncost){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.returncostBVO");
    }
   }
