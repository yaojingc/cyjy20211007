...
public class ReturncostHVO extends SuperVO {
	
/**
*退费申请主键
*/
public java.lang.String pk_returncost;
/**
*集团
*/
...
*开户行
*/
public java.lang.String openbank;
/**
*家长姓名
*/
...
*进班时间
*/
public UFDate inclassdate;
/**
*退班时间
*/
public UFDate outclassdate;
/**
*上课进度
*/
public java.lang.String classsched;
/**
*学费总金额
*/
public nc.vo.pub.lang.UFDouble totalmoney;
/**
*已交学费
*/
public nc.vo.pub.lang.UFDouble paymoney;
/**
*申请退费金额
*/
public nc.vo.pub.lang.UFDouble retuencost;
/**
*累计原币应收金额
*/
public nc.vo.pub.lang.UFDouble receivable;
/**
*累计原币收款金额
*/
public nc.vo.pub.lang.UFDouble collection;
/**
*时间戳
*/
...
/**
* 属性 pk_returncost的Getter方法.属性名：退费申请主键
*  创建日期:2021-9-9
* @return java.lang.String
*/
public java.lang.String getPk_returncost() {
return this.pk_returncost;
} 

/**
* 属性pk_returncost的Setter方法.属性名：退费申请主键
* 创建日期:2021-9-9
* @param newPk_returncost java.lang.String
*/
public void setPk_returncost ( java.lang.String pk_returncost) {
this.pk_returncost=pk_returncost;
} 
...
/**
* 属性 bankaccount的Getter方法.属性名：个人银行账号
*  创建日期:2021-9-9
* @return java.lang.String
*/
...
/**
* 属性bankaccount的Setter方法.属性名：个人银行账号
* 创建日期:2021-9-9
* @param newBankaccount java.lang.String
*/
...
/**
* 属性openbank的Setter方法.属性名：开户行
* 创建日期:2021-9-9
* @param newOpenbank java.lang.String
*/
...
/**
* 属性 inclassdate的Getter方法.属性名：进班时间
*  创建日期:2021-9-9
* @return nc.vo.pub.lang.UFDate
*/
public UFDate getInclassdate() {
return this.inclassdate;
} 

/**
* 属性inclassdate的Setter方法.属性名：进班时间
* 创建日期:2021-9-9
* @param newInclassdate nc.vo.pub.lang.UFDate
*/
public void setInclassdate ( UFDate inclassdate) {
this.inclassdate=inclassdate;
} 
 
/**
* 属性 outclassdate的Getter方法.属性名：退班时间
*  创建日期:2021-9-9
* @return nc.vo.pub.lang.UFDate
*/
public UFDate getOutclassdate() {
return this.outclassdate;
} 

/**
* 属性outclassdate的Setter方法.属性名：退班时间
* 创建日期:2021-9-9
* @param newOutclassdate nc.vo.pub.lang.UFDate
*/
public void setOutclassdate ( UFDate outclassdate) {
this.outclassdate=outclassdate;
} 
 
/**
* 属性 classsched的Getter方法.属性名：上课进度
*  创建日期:2021-9-9
* @return java.lang.String
*/
public java.lang.String getClasssched() {
return this.classsched;
} 

/**
* 属性classsched的Setter方法.属性名：上课进度
* 创建日期:2021-9-9
* @param newClasssched java.lang.String
*/
public void setClasssched ( java.lang.String classsched) {
this.classsched=classsched;
} 
 
/**
* 属性 totalmoney的Getter方法.属性名：学费总金额
*  创建日期:2021-9-9
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getTotalmoney() {
return this.totalmoney;
} 

/**
* 属性totalmoney的Setter方法.属性名：学费总金额
* 创建日期:2021-9-9
* @param newTotalmoney nc.vo.pub.lang.UFDouble
*/
public void setTotalmoney ( nc.vo.pub.lang.UFDouble totalmoney) {
this.totalmoney=totalmoney;
} 
 
/**
* 属性 paymoney的Getter方法.属性名：已交学费
*  创建日期:2021-9-9
* @return nc.vo.pub.lang.UFDouble
*/
...
/**
* 属性paymoney的Setter方法.属性名：已交学费
* 创建日期:2021-9-9
* @param newPaymoney nc.vo.pub.lang.UFDouble
*/
public void setPaymoney ( nc.vo.pub.lang.UFDouble paymoney) {
this.paymoney=paymoney;
} 
 
/**
* 属性 retuencost的Getter方法.属性名：申请退费金额
*  创建日期:2021-9-9
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getRetuencost() {
return this.retuencost;
} 

/**
* 属性retuencost的Setter方法.属性名：申请退费金额
* 创建日期:2021-9-9
* @param newRetuencost nc.vo.pub.lang.UFDouble
*/
public void setRetuencost ( nc.vo.pub.lang.UFDouble retuencost) {
this.retuencost=retuencost;
} 
 
/**
* 属性 receivable的Getter方法.属性名：累计原币应收金额
*  创建日期:2021-9-9
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getReceivable() {
return this.receivable;
} 

/**
* 属性receivable的Setter方法.属性名：累计原币应收金额
* 创建日期:2021-9-9
* @param newReceivable nc.vo.pub.lang.UFDouble
*/
public void setReceivable ( nc.vo.pub.lang.UFDouble receivable) {
this.receivable=receivable;
} 
 
/**
* 属性 collection的Getter方法.属性名：累计原币收款金额
*  创建日期:2021-9-9
* @return nc.vo.pub.lang.UFDouble
*/
public nc.vo.pub.lang.UFDouble getCollection() {
return this.collection;
} 

/**
* 属性collection的Setter方法.属性名：累计原币收款金额
* 创建日期:2021-9-9
* @param newCollection nc.vo.pub.lang.UFDouble
*/
public void setCollection ( nc.vo.pub.lang.UFDouble collection) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.returncostHVO");
    }
   }
