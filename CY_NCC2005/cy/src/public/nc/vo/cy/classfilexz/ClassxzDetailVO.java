...
public class ClassxzDetailVO extends SuperVO {
...
* @return String
*/
public String getPk_classxz(){
return this.pk_classxz;
}
/**
* ���������ϲ�������Setter����.���������ϲ�����
* ��������:2021-8-17
* @param newPk_classxz String
*/
public void setPk_classxz(String pk_classxz){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("cy.classxzDetailVO");
    }
   }
