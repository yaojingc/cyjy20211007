...
import nc.utils.commonConstant.Unicode;
import nc.utils.commonplugin.NoteDataUtils;
import nc.vo.pub.BusinessException;

/**
 * param1:消息正文 param2:待发送用户数组 param3：消息模板id
 * 
 * @author yao
 */
public class SmsUtils {
	public static String sendSms(String smsContent[], String[] phoneNumbers, String templateid) throws BusinessException {
		try {
			/*
			 ...
			 */
			Credential cred = new Credential(AppletsParams.smssecretid, AppletsParams.smssecretkey);
...
//            httpProfile.setProxyPort(port);
			...
			String appid = AppletsParams.smssdkappid;
			req.setSmsSdkAppid(appid);

			/* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
			String sign = AppletsParams.smssign;//"湖北词源教育有限公司";//AppletsParams.smssign;
			req.setSign(sign);
...
//            req.setExtendCode(extendcode);
			...
			String templateID = templateid;//AppletsParams.smstemplateid;
...
//            String[] phoneNumbers = {"+8621212313123", "+8612345678902", "+8612345678903"};
			...
			/* 模板参数: 若无模板参数，则设置为空 */
//			String[] templateParams =  smsContent ;
			req.setTemplateParamSet(smsContent);
			...
			String exceptionCode = res.getSendStatusSet()[0].getCode();
			if("Ok".equals(exceptionCode)) {
				return "OK";
			} else {
				NoteDataUtils.addLog(phoneNumbers+" : "+exceptionCode, "催费短信推送异常", false, null);
				return "NOK";
			}
	...
	public static String generateVerificateCode() {
