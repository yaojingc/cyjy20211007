 ...
 * @since v3.5.6-1903
 */
public class PlantravelHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XCAP";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_plantravel";
       ...
       */
      // 行程安排应用编码
      public static String CONST_CODE_APPCODE = "81H10565";
      ...
      // 行程安排卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10565_CARD";

      // 行程安排列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10565_LIST";
