 ...
 * @since v3.5.6-1903
 */
public class TestpaperfileHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "SJDA";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_testpaperfile";
       ...
       */
      // 试卷档案应用编码
      public static String CONST_CODE_APPCODE = "81H11020";
      ...
      // 试卷档案卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11020_CARD";

      // 试卷档案列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11020_LIST";
