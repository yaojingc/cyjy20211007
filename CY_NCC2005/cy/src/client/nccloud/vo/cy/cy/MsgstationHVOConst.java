 ...
 * @since v3.5.6-1903
 */
public class MsgstationHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XXZZ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_msgstation";
       ...
       */
      // 消息中转站应用编码
      public static String CONST_CODE_APPCODE = "81H10131";
      ...
      // 消息中转站卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10131_CARD";

      // 消息中转站列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10131_LIST";
