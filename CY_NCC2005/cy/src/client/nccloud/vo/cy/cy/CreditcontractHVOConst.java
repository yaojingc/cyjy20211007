 ...
 * @since v3.5.6-1903
 */
public class CreditcontractHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "SKHT";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_contract";
       ...
       */
      // 学费收款合同应用编码
      public static String CONST_CODE_APPCODE = "81H11505";
      ...
      // 学费收款合同卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11505_CARD";

      // 学费收款合同列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11505_LIST";
