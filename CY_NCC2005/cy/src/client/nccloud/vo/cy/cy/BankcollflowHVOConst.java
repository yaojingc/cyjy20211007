 ...
 * @since v3.5.6-1903
 */
public class BankcollflowHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "SKLS";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_bank";
       ...
       */
      // 银行收款流水应用编码
      public static String CONST_CODE_APPCODE = "81H11510";
      ...
      // 银行收款流水卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11510_CARD";

      // 银行收款流水列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11510_LIST";
