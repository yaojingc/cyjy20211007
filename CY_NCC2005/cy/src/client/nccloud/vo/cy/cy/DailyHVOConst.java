...
public class DailyHVOConst {
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "GZRB";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_daily";
       ...
       */
      // 日报应用编码
      public static String CONST_CODE_APPCODE = "81H10510";
      ...
      // 日报卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10510_CARD";

      // 日报列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10510_LIST";
