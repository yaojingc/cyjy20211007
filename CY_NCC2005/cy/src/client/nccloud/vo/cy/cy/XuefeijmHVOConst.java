...
public class XuefeijmHVOConst {
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XFJM";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_xfapply";
       ...
       */
      // 学费减免申请单应用编码
      public static String CONST_CODE_APPCODE = "81H10540";
      ...
      // 学费减免申请单卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10540_CARD";

      // 学费减免申请单列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10540_LIST";
