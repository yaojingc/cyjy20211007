 ...
 * @since v3.5.6-1903
 */
public class ReturncostHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "TFSQ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_returncost";
       ...
       */
      // 退费申请单应用编码
      public static String CONST_CODE_APPCODE = "81H11515";
      ...
      // 退费申请单卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11515_CARD";

      // 退费申请单列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11515_LIST";
