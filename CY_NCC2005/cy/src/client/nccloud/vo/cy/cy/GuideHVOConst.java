...
public class GuideHVOConst {
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XSZN";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_guide";
       ...
       */
      // 新手指南应用编码
      public static String CONST_CODE_APPCODE = "81H11017";
      ...
      // 新手指南卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11017_CARD";

      // 新手指南列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11017_LIST";
