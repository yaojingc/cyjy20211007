 ...
 * @since v3.5.6-1903
 */
public class ClassituationHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "SKQK";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_situation";
       ...
       */
      // 学生上课情况应用编码
      public static String CONST_CODE_APPCODE = "81H11035";
      ...
      // 学生上课情况卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11035_CARD";

      // 学生上课情况列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11035_LIST";
