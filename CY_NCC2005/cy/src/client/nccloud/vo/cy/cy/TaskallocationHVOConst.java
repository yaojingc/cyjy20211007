 ...
 * @since v3.5.6-1903
 */
public class TaskallocationHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "RWFP";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_taskallocation";
       ...
       */
      // 任务分配应用编码
      public static String CONST_CODE_APPCODE = "81H10555";
      ...
      // 任务分配卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10555_CARD";

      // 任务分配列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10555_LIST";
