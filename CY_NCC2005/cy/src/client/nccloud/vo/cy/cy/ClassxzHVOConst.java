...
public class ClassxzHVOConst {
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XZBJ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_classxz";
       ...
       */
      // 行政班级档案应用编码
      public static String CONST_CODE_APPCODE = "81H10120";
      ...
      // 行政班级档案卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10120_CARD";

      // 行政班级档案列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10120_LIST";
