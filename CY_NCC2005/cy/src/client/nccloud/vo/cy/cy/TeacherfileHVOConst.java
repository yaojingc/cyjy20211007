 ...
 * @since v3.5.6-1903
 */
public class TeacherfileHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "LSDA";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_teachfile";
       ...
       */
      // 老师档案应用编码
      public static String CONST_CODE_APPCODE = "81H10110";
      ...
      // 老师档案卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10110_CARD";

      // 老师档案列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10110_LIST";
