 ...
 * @since v3.5.6-1903
 */
public class CallcenterHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "KFTD";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_callcenter";
       ...
       */
      // 客服通道应用编码
      public static String CONST_CODE_APPCODE = "81H11001";
      ...
      // 客服通道卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11001_CARD";

      // 客服通道列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11001_LIST";
