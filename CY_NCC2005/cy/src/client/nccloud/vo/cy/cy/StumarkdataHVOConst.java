 ...
 * @since v3.5.6-1903
 */
public class StumarkdataHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XSCJ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_stumark";
       ...
       */
      // 学生成绩库应用编码
      public static String CONST_CODE_APPCODE = "81H11025";
      ...
      // 学生成绩库卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11025_CARD";

      // 学生成绩库列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11025_LIST";
