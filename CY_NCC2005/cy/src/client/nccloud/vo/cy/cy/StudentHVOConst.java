...
public class StudentHVOConst {
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XSDA";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_student";
       ...
       */
      // 学生档案应用编码
      public static String CONST_CODE_APPCODE = "81H10105";
      ...
      // 学生档案卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10105_CARD";

      // 学生档案列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10105_LIST";
