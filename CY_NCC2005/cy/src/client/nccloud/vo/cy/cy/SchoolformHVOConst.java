 ...
 * @since v3.5.6-1903
 */
public class SchoolformHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "XXSQ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_schoolf";
       ...
       */
      // 新发现学校申请单应用编码
      public static String CONST_CODE_APPCODE = "81H10501";
      ...
      // 新发现学校申请单卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10501_CARD";

      // 新发现学校申请单列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10501_LIST";
