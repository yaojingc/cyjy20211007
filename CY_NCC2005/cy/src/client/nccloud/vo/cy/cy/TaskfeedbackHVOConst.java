 ...
 * @since v3.5.6-1903
 */
public class TaskfeedbackHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "RWFK";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_taskfeedback";
       ...
       */
      // 任务分配反馈应用编码
      public static String CONST_CODE_APPCODE = "81H10560";
      ...
      // 任务分配反馈卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10560_CARD";

      // 任务分配反馈列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10560_LIST";
