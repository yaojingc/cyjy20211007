...
public class ClasscyHVOConst {
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "CYBJ";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_classcy";
       ...
       */
      // 词源班级档案应用编码
      public static String CONST_CODE_APPCODE = "81H10115";
      ...
      // 词源班级档案卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10115_CARD";

      // 词源班级档案列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10115_LIST";
