...
public class WorkplanHVOConst {
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "GZJH";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_workplan";
       ...
       */
      // 工作计划应用编码
      public static String CONST_CODE_APPCODE = "81H10550";
      ...
      // 工作计划卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H10550_CARD";

      // 工作计划列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H10550_LIST";
