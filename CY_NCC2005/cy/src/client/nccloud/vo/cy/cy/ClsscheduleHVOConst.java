 ...
 * @since v3.5.6-1903
 */
public class ClsscheduleHVOConst {
         /**
       * 单据操作
       */
       ...
       * 单据类型
       */
      public static String CONST_BILLTYPE_COST = "KBDY";

        /**
        * 主表主键字段
        */
        public static String CONST_PARENT_PRIMARYKEY = "pk_clsschedule";
       ...
       */
      // 课表定义应用编码
      public static String CONST_CODE_APPCODE = "81H11030";
      ...
      // 课表定义卡片页面编码
      public static String CONST_CODE_PAGECODE_COST_CARD = "81H11030_CARD";

      // 课表定义列表页面编码
      public static String CONST_CODE_PAGECODE_COST_LIST = "81H11030_LIST";
