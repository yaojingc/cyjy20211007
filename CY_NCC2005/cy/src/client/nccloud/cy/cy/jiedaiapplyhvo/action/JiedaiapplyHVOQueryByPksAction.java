 ...
 */
public class JiedaiapplyHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggJiedaiapplyHVO bill : bills) {
   ...
   */
  private Collection<AggJiedaiapplyHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_jiedaiapply",queryParam.getPks());
    Collection<AggJiedaiapplyHVO> bills =
        service.queryBillOfVOByCond(AggJiedaiapplyHVO.class, wheresql, false,
            false);
    return bills;
  }
}
