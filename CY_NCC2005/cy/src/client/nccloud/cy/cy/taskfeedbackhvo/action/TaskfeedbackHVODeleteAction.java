 ...
 */
public class TaskfeedbackHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggTaskfeedbackHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return TaskfeedbackHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggTaskfeedbackHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggTaskfeedbackHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_taskfeedback", queryParam.getPks());
    ...
    return bills.toArray(new AggTaskfeedbackHVO[0]);
  }
}
