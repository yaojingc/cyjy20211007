...
package nccloud.cy.cy.taskfeedbackhvo.cy.util;
...
public class CommonUtil {
  ...
  private static ITaskfeedbackhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return TaskfeedbackHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ITaskfeedbackhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ITaskfeedbackhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(TaskfeedbackHVOConst.CONST_TS, ts);
    }
  }
