 ...
 */
public class TaskfeedbackHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggTaskfeedbackHVO bill : bills) {
  ...
  private Collection<AggTaskfeedbackHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_taskfeedback",queryParam.getPks());
    Collection<AggTaskfeedbackHVO> bills =
        service.queryBillOfVOByCond(AggTaskfeedbackHVO.class, wheresql, false,
            false);
    return bills;
  }
}
