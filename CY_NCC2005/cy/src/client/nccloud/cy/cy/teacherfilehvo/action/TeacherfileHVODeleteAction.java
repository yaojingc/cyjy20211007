 ...
 */
public class TeacherfileHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggTeacherfileHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return TeacherfileHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggTeacherfileHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggTeacherfileHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_teachfile", queryParam.getPks());
    ...
    return bills.toArray(new AggTeacherfileHVO[0]);
  }
}
