 ...
 */
public class TeacherfileHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggTeacherfileHVO bill : bills) {
  ...
  private Collection<AggTeacherfileHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_teachfile",queryParam.getPks());
    Collection<AggTeacherfileHVO> bills =
        service.queryBillOfVOByCond(AggTeacherfileHVO.class, wheresql, false,
            false);
    return bills;
  }
}
