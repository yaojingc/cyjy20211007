 ...
 */
public class TaskallocationHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggTaskallocationHVO bill : bills) {
  ...
  private Collection<AggTaskallocationHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_taskallocation",queryParam.getPks());
    Collection<AggTaskallocationHVO> bills =
        service.queryBillOfVOByCond(AggTaskallocationHVO.class, wheresql, false,
            false);
    return bills;
  }
}
