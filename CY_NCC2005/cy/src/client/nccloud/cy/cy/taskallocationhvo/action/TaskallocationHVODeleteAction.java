 ...
 */
public class TaskallocationHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggTaskallocationHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return TaskallocationHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggTaskallocationHVO... aggVOs)
      throws BusinessException {
    ...
    String billType = TaskallocationHVOConst.CONST_BILLTYPE_COST;
...
BillOperatorParam queryParam =
   ...
   */
  private AggTaskallocationHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_taskallocation", queryParam.getPks());
    ...
    return bills.toArray(new AggTaskallocationHVO[0]);
  }
}
