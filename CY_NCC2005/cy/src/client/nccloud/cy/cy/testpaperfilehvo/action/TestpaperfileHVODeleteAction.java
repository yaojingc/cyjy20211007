 ...
 */
public class TestpaperfileHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggTestpaperfileHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return TestpaperfileHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggTestpaperfileHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggTestpaperfileHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_testpaperfile", queryParam.getPks());
    ...
    return bills.toArray(new AggTestpaperfileHVO[0]);
  }
}
