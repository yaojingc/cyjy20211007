...
package nccloud.cy.cy.testpaperfilehvo.cy.util;
...
public class CommonUtil {
  ...
  private static ITestpaperfilehvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return TestpaperfileHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ITestpaperfilehvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ITestpaperfilehvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(TestpaperfileHVOConst.CONST_TS, ts);
    }
  }
