 ...
 */
public class DailyHVOQueryByPksAction implements ICommonAction {
   ...
   */
  private Collection<AggDailyHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_daily",queryParam.getPks());
    Collection<AggDailyHVO> bills =
        service.queryBillOfVOByCond(AggDailyHVO.class, wheresql, false,
            false);
    return bills;
  }
}
