 ...
 */
public class SalesmanfileHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggSalesmanfileHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return SalesmanfileHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggSalesmanfileHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggSalesmanfileHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_salesman", queryParam.getPks());
    ...
    return bills.toArray(new AggSalesmanfileHVO[0]);
  }
}
