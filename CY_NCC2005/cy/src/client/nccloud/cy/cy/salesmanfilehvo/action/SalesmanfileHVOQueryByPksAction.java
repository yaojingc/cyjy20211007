 ...
 */
public class SalesmanfileHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggSalesmanfileHVO bill : bills) {
  ...
  private Collection<AggSalesmanfileHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_salesman",queryParam.getPks());
    Collection<AggSalesmanfileHVO> bills =
        service.queryBillOfVOByCond(AggSalesmanfileHVO.class, wheresql, false,
            false);
    return bills;
  }
}
