...
package nccloud.cy.cy.salesmanfilehvo.cy.util;
...
public class CommonUtil {
  ...
  private static ISalesmanfilehvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return SalesmanfileHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ISalesmanfilehvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ISalesmanfilehvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(SalesmanfileHVOConst.CONST_TS, ts);
    }
  }
