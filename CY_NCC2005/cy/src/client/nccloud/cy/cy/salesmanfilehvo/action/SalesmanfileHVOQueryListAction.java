...
import nccloud.cy.cy.salesmanfilehvo.cy.bean.PageQueryVO;
 ...
 */
public class SalesmanfileHVOQueryListAction implements ICommonAction {
  ...
  private Grid covert(PageQueryVO pagevo, int pageSize, String pagecode) {
    AggSalesmanfileHVO[] bills =
        (AggSalesmanfileHVO[]) pagevo.getCurrentPageBills();
  ...
  private PageQueryVO createNullPage() {
    ...
    AggSalesmanfileHVO[] bills =
        Constructor.construct(AggSalesmanfileHVO.class, 0);
   ...
   * @return
   */
  private AggSalesmanfileHVO[] getDefaulePageBill(QueryTreeFormatVO info,
      AggSalesmanfileHVO... aggvos) {
    ...
    List<AggSalesmanfileHVO> billLst = new ArrayList<AggSalesmanfileHVO>();
    for (int i = 0; (i < aggvos.length) && (i < pageSize); i++) {
      AggSalesmanfileHVO bill = new AggSalesmanfileHVO();

      bill.setParent(aggvos[i].getParent());
      billLst.add(bill);
    }
    return billLst.toArray(new AggSalesmanfileHVO[0]);
  }
   ...
   * @return
   */
  private String[] getPks(AggSalesmanfileHVO... aggvos) {
    List<String> pks = new ArrayList<String>();
    for (AggSalesmanfileHVO bill : aggvos) {
