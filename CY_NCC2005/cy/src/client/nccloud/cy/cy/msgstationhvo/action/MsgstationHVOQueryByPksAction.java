 ...
 */
public class MsgstationHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggMsgstationHVO bill : bills) {
  ...
  private Collection<AggMsgstationHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_msgstation",queryParam.getPks());
    Collection<AggMsgstationHVO> bills =
        service.queryBillOfVOByCond(AggMsgstationHVO.class, wheresql, false,
            false);
    return bills;
  }
}
