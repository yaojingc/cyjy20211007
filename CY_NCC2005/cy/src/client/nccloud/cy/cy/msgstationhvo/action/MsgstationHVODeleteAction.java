 ...
 */
public class MsgstationHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggMsgstationHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return MsgstationHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggMsgstationHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggMsgstationHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_msgstation", queryParam.getPks());
    ...
    return bills.toArray(new AggMsgstationHVO[0]);
  }
}
