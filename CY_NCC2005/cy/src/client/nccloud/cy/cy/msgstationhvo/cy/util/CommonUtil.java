...
package nccloud.cy.cy.msgstationhvo.cy.util;
...
public class CommonUtil {
  ...
  private static IMsgstationhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return MsgstationHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IMsgstationhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IMsgstationhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(MsgstationHVOConst.CONST_TS, ts);
    }
  }
