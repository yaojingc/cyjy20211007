 ...
 */
public class ClassxzHVOQueryByPksAction implements ICommonAction {
	 ...
	 * @return
	 */
	protected Object transGrid(PageQueryInfo info, Collection<AggClassxzHVO> bills) {
	...
	private Collection<AggClassxzHVO> queryBills(PageQueryInfo queryParam) throws MetaDataException {
		...
		String wheresql = SQLUtil.buildSqlForIn("pk_classxz", queryParam.getPks());
		Collection<AggClassxzHVO> bills = service.queryBillOfVOByCond(AggClassxzHVO.class, wheresql, false, false);
		return bills;
	}
}
