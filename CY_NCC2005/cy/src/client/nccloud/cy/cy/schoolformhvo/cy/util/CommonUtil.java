...
package nccloud.cy.cy.schoolformhvo.cy.util;
...
public class CommonUtil {
	...
	private static ISchoolformhvoMaintain maintain = null;
	 ...
	 * @return
	 */
	public static Grid displayGridManager(Grid grid, AggSchoolformHVO[] bills) {
//		if (null == grid) {
//			return grid;
//		}
//		Set<String> setDef1 = new HashSet<String>();
//		for (AggSchoolformHVO aggvo : bills) {
//			SchoolformHVO hvo = aggvo.getParentVO();
//			// def1：学校
...
//		}
	 ...
	 * @return
	 */
	public static BillCard displayCardManager(BillCard billCard, AggSchoolformHVO bill) {
		// def1：学校 ，def2：班级
//		Set<String> setDef1 = new HashSet<String>();
//		SchoolformHVO hvo = bill.getParentVO();
//		// def1：学校 ，
//		String def1 = hvo.getDef1();
//		if (MMValueCheck.isNotEmpty(def1)) {
//			setDef1.add(def1);
...
//		}
	...
	public static String getBillTypeCode() {
		return SchoolformHVOConst.CONST_BILLTYPE_COST;
	}
	 ...
	 * @return
	 */
	public static synchronized ISchoolformhvoMaintain getFinancingcostMaintainService() {
		if (CommonUtil.maintain == null) {
			CommonUtil.maintain = ServiceLocator.find(ISchoolformhvoMaintain.class);
		}
	...
	public static void setBillsTs(Map<String, String> pkMapTs, AbstractBill[] bills) {
		...
		for (AbstractBill bill : bills) {
			...
			bill.getParent().setAttributeValue(SchoolformHVOConst.CONST_TS, ts);
		}
	}
