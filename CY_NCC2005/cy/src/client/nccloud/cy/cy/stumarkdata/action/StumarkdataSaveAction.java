 ...
 */
public class StumarkdataSaveAction implements ICommonAction {
...
AggStumarkdataHVO rtnObj = this.callActionScript(vo);
  ...
  protected String getActionCode() {
    return StumarkdataConst.CONST_ACTION_SAVEBASE;
  }
   ...
   */
  private AggStumarkdataHVO callActionScript(AggStumarkdataHVO... aggVOs)
      throws BusinessException {

    String actionCode = this.getActionCode();
    String billType = StumarkdataConst.CONST_BILLTYPE_COST;
    ...
    String wheresql =
        "pk_stumark" + "='"
            + ((AggStumarkdataHVO) result[0]).getPrimaryKey() + "'";
