 ...
 */
public class StumarkdataQueryByPksAction implements ICommonAction {
   ...
   */
  private Collection<AggStumarkdataHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_stumark",queryParam.getPks());
    Collection<AggStumarkdataHVO> bills =
        service.queryBillOfVOByCond(AggStumarkdataHVO.class, wheresql, false,
            false);
    return bills;
  }
}
