...
import nccloud.cy.cy.stumarkdata.cy.bean.PageQueryVO;
 ...
 */
public class StumarkdataQueryListAction implements ICommonAction {
  ...
  private Grid covert(PageQueryVO pagevo, int pageSize, String pagecode) {
    AggStumarkdataHVO[] bills =
        (AggStumarkdataHVO[]) pagevo.getCurrentPageBills();
  ...
  private PageQueryVO createNullPage() {
    ...
    AggStumarkdataHVO[] bills =
        Constructor.construct(AggStumarkdataHVO.class, 0);
   ...
   * @return
   */
  private AggStumarkdataHVO[] getDefaulePageBill(QueryTreeFormatVO info,
      AggStumarkdataHVO... aggvos) {
