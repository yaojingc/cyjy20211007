 ...
 */
public class ClsscheduleHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggClsscheduleHVO bill : bills) {
   ...
   */
  private Collection<AggClsscheduleHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_clsschedule",queryParam.getPks());
    Collection<AggClsscheduleHVO> bills =
        service.queryBillOfVOByCond(AggClsscheduleHVO.class, wheresql, false,
            false);
    return bills;
  }
}
