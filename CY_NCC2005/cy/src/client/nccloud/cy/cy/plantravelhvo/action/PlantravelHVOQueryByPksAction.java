 ...
 */
public class PlantravelHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggPlantravelHVO bill : bills) {
   ...
   */
  private Collection<AggPlantravelHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_plantravel",queryParam.getPks());
    Collection<AggPlantravelHVO> bills =
        service.queryBillOfVOByCond(AggPlantravelHVO.class, wheresql, false,
            false);
    return bills;
  }
}
