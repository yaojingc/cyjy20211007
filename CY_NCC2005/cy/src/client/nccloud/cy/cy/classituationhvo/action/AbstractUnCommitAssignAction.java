...
public abstract class AbstractUnCommitAssignAction<T extends AbstractBill>
  ...
  public Object callAutoUnApproveActionScript(AggClassituationHVO[] commitVOs,
  ...
  protected Object callActionScript(AggClassituationHVO[] commitVOs,
                                    String billType) throws BusinessException {
  ...
  protected Object unCommit(AggClassituationHVO[] commitVOs)
          throws BusinessException {
    Object result = null;
    // 判断是否定义审批流
    boolean hasFlow = NCCFlowUtils.hasApproveflowDef(
            ClassituationHVOConst.CONST_BILLTYPE_COST, commitVOs[0]);
    for (AggClassituationHVO vo : commitVOs) {
      Integer vbillstatus = (Integer) vo.getParent()
              .getAttributeValue(ClassituationHVOConst.CONST_BILL_STATUS);
