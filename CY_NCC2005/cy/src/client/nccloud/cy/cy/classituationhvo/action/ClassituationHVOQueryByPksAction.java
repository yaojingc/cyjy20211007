 ...
 */
public class ClassituationHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggClassituationHVO bill : bills) {
   ...
   */
  private Collection<AggClassituationHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_situation",queryParam.getPks());
    Collection<AggClassituationHVO> bills =
        service.queryBillOfVOByCond(AggClassituationHVO.class, wheresql, false,
            false);
    return bills;
  }
}
