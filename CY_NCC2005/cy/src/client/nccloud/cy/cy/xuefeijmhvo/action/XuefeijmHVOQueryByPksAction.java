 ...
 */
public class XuefeijmHVOQueryByPksAction implements ICommonAction {
   ...
   */
  private Collection<AggXuefeijmHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_xfapply",queryParam.getPks());
    Collection<AggXuefeijmHVO> bills =
        service.queryBillOfVOByCond(AggXuefeijmHVO.class, wheresql, false,
            false);
    return bills;
  }
}
