 ...
 */
public class ReturncostHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggReturncostHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return ReturncostHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggReturncostHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggReturncostHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_returncost", queryParam.getPks());
    ...
    return bills.toArray(new AggReturncostHVO[0]);
  }
}
