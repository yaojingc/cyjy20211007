 ...
 */
public class ReturncostHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggReturncostHVO bill : bills) {
  ...
  private Collection<AggReturncostHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_returncost",queryParam.getPks());
    Collection<AggReturncostHVO> bills =
        service.queryBillOfVOByCond(AggReturncostHVO.class, wheresql, false,
            false);
    return bills;
  }
}
