...
public class CommonUtil {
  ...
  private static IReturncosthvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return ReturncostHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IReturncosthvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IReturncosthvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(ReturncostHVOConst.CONST_TS, ts);
    }
  }
