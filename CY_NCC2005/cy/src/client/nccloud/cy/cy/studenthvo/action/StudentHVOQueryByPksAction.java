 ...
 */
public class StudentHVOQueryByPksAction implements ICommonAction {
   ...
   */
  private Collection<AggStudentHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_student",queryParam.getPks());
    Collection<AggStudentHVO> bills =
        service.queryBillOfVOByCond(AggStudentHVO.class, wheresql, false,
            false);
    return bills;
  }
}
