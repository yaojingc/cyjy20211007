...
package nccloud.cy.cy.bankcollflowhvo.cy.util;
...
public class CommonUtil {
  ...
  private static IBankcollflowhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return BankcollflowHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IBankcollflowhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IBankcollflowhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(BankcollflowHVOConst.CONST_TS, ts);
    }
  }
