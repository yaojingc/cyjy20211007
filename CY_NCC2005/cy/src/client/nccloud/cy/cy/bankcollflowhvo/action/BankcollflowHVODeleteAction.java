 ...
 */
public class BankcollflowHVODeleteAction implements ICommonAction {
...
BillOperatorParam queryParam = this.getQueryParam(paramIRequest);
    try {
      ...
      AggBankcollflowHVO[] bills = this.queryBills(queryParam);
      // ts赋值
  ...
  protected String getActionCode() {
    return BankcollflowHVOConst.CONST_ACTION_DELETE;
  }
   ...
   */
  private Object callActionScript(AggBankcollflowHVO... aggVOs)
      throws BusinessException {
...
BillOperatorParam queryParam =
   ...
   */
  private AggBankcollflowHVO[] queryBills(BillOperatorParam queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql = SQLUtil.buildSqlForIn(
        "pk_bank", queryParam.getPks());
    ...
    return bills.toArray(new AggBankcollflowHVO[0]);
  }
}
