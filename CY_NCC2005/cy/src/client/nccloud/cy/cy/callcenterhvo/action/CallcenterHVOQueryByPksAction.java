 ...
 */
public class CallcenterHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggCallcenterHVO bill : bills) {
  ...
  private Collection<AggCallcenterHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_callcenter",queryParam.getPks());
    Collection<AggCallcenterHVO> bills =
        service.queryBillOfVOByCond(AggCallcenterHVO.class, wheresql, false,
            false);
    return bills;
  }
}
