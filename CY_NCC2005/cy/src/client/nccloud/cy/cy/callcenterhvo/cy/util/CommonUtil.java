...
package nccloud.cy.cy.callcenterhvo.cy.util;
...
public class CommonUtil {
  ...
  private static ICallcenterhvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return CallcenterHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ICallcenterhvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ICallcenterhvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(CallcenterHVOConst.CONST_TS, ts);
    }
  }
