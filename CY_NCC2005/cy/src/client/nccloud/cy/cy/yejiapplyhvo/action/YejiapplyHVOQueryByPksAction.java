 ...
 */
public class YejiapplyHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggYejiapplyHVO bill : bills) {
   ...
   */
  private Collection<AggYejiapplyHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_yejiapply",queryParam.getPks());
    Collection<AggYejiapplyHVO> bills =
        service.queryBillOfVOByCond(AggYejiapplyHVO.class, wheresql, false,
            false);
    return bills;
  }
}
