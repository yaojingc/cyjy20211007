 ...
 */
public class SchoolBasicsHVOQueryByPksAction implements ICommonAction {
  ...
  protected Object transGrid(PageQueryInfo info,
    ...
    int i = 0;
    for (AggSchoolBasicsHVO bill : bills) {
   ...
   */
  private Collection<AggSchoolBasicsHVO> queryBills(PageQueryInfo queryParam)
      throws MetaDataException {
    // 1、根据参数查询结果
    IMDPersistenceQueryService service = CommonUtil.getMDPersistenceQueryService();
    String wheresql =
        SQLUtil.buildSqlForIn("pk_school",queryParam.getPks());
    Collection<AggSchoolBasicsHVO> bills =
        service.queryBillOfVOByCond(AggSchoolBasicsHVO.class, wheresql, false,
            false);
    return bills;
  }
}
