...
package nccloud.cy.cy.schoolbasicshvo.cy.util;
...
public class CommonUtil {
  ...
  private static ISchoolbasicshvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return SchoolBasicsHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized ISchoolbasicshvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(ISchoolbasicshvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(SchoolBasicsHVOConst.CONST_TS, ts);
    }
  }
