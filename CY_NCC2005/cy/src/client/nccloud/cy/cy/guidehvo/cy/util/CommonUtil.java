...
package nccloud.cy.cy.guidehvo.cy.util;
...
public class CommonUtil {
  ...
  private static IGuidehvoMaintain maintain = null;
  ...
  public static String getBillTypeCode() {
    return GuideHVOConst.CONST_BILLTYPE_COST;
  }
...
/**
   ...
   * @return
   */
  public static synchronized IGuidehvoMaintain getFinancingcostMaintainService() {
    if (CommonUtil.maintain == null) {
      CommonUtil.maintain = ServiceLocator.find(IGuidehvoMaintain.class);
    }
  ...
  public static void setBillsTs(Map<String, String> pkMapTs,
    ...
    for (AbstractBill bill : bills) {
      ...
      bill.getParent().setAttributeValue(GuideHVOConst.CONST_TS, ts);
    }
  }
