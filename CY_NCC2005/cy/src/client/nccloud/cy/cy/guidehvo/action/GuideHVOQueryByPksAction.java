 ...
 */
public class GuideHVOQueryByPksAction implements ICommonAction {
  ...
  private Collection<AggGuideHVO> queryBills(PageQueryInfo queryParam)
    ...
    String wheresql =
        SQLUtil.buildSqlForIn("pk_guide",queryParam.getPks());
    Collection<AggGuideHVO> bills =
        service.queryBillOfVOByCond(AggGuideHVO.class, wheresql, false,
            false);
    return bills;
  }
}
