 ...
 * 标准单据收回的BP
 */
public class AceSchoolBasicsHVOUnSendApproveBP {

        public AggSchoolBasicsHVO[] unSend(AggSchoolBasicsHVO[] clientBills,
        ...
        private void setHeadVOStatus(AggSchoolBasicsHVO[] clientBills) {
